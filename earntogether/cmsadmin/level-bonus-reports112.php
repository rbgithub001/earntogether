...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Level Income' and status=0 $qry order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <?php  $user1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['sender_id']."'")); ?>
                                <td>
                                    <?php echo $data1['sender_id'];?>
                                </td>
                                <td>
                               ...
                               <td>
                                ...
                                <td>
                                     <?php if($data1['status']==0) echo "Unpaid"; else echo "Paid";?>
                                </td>
                                 <td>
                                     <?php echo $data1['ts'];?>
                                </td>
