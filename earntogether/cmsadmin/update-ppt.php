...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from ppt where id='".$id."'");
...
$str="update ppt set logo_title='".$title."',logo_desc='".$content."',logo_name='".$img."',date='".$date."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_ppt.php?id=". $id."&msg=PPT Updated Successfully !");
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">PPT title</label>
                                    <div class="col-lg-10">
                                 ...
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload PPT:</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">PPT Description</label>
                                    <div class="col-lg-10">
