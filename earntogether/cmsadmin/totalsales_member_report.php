                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                Members for Sales/Referral  Reports
    ...
    <div class="total_invoice"  id="printArea">
                         ...
                         Total Right Point
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select registration_date,concat(first_name,' ',last_name) as name,username,user_id,(select count(id) from user_registration where ref_id=r.user_id and r.master_account!='')  as count from user_registration as r $query123 order by count desc limit 30 ");
                            ...
                            $querys1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(pair) as totalleftamount from manage_bv_history where status='0' and income_id='$id' and position='left'"));
$leftamt=$querys1['totalleftamount'];

$querys12=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(pair) as totalrightamount from manage_bv_history where status='0' and income_id='$id' and position='right'"));
$rightamt=$querys12['totalrightamount'];
                            $query2="select * from user_registration where ref_id='$id' ";
                            $q2=mysqli_query($GLOBALS["___mysqli_ston"], $query2);
                            while($row=mysqli_fetch_assoc($q2))
                            {
                                $at=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(amount) as totu  from lifejacket_subscription where user_id='$row[user_id]'"));
                                $sum=$sum+$at['totu']; 
                            }
    ...
    $data123=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(amount) as leadtot12 from  lifejacket_subscription where user_id='".$data1['user_id']."' and date between '$date1' and '$date2' ")); 
