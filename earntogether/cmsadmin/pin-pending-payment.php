...
<body class="sticky-header">
 ...
 <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php 
                                $i=1;
                                $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from pin_paymentproof");
         ...
         <option value="approve-status-pin.php?user=<?php echo $data1['user_id'];?>&status=1&id=<?php echo $data1['id']; ?>" <?php if($data1['double_promotion']=='1'){ echo "selected";}?>>Approve</option>
         <option value="approve-status-pin.php?user=<?php echo $data1['user_id'];?>&status=2&id=<?php echo $data1['id']; ?>"  <?php if($data1['double_promotion']=='2'){ echo "selected";}?>>Cancel</option>
   
  </select>    <?php  }else if ($data1['status']==1){ ?>

   <b> <span style="color: green;">Approved</span></b>
 <?php }else if ($data1['status']==2){ ?>

    <b> <span style="color: red;">Cancelled</span></b>
 <?php }  ?>
             </td>                   
