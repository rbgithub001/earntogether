...
if(!isset($_SESSION['token_id'])){
  ...
  if($_SESSION['token_id'] != md5($_SESSION['user_id']))
   ...
   $id=$_GET['pid'];
   $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from header_menu where id='".$id."'");
...
$date = date ("Y-m-d H:i:s");
  ...
  echo $sql="UPDATE  header_menu  SET menu_name = '".$menu_name."' ,  url_link ='".$url_link."' ,  icon ='".$img1."', m_date='".$date."' WHERE  id='$id' " ;    
  
  mysqli_query($GLOBALS["___mysqli_ston"],  $sql) ; 

	$msg="Update slider Uploaded";
                ...
                <div class="col-lg-7 center-block" style="float:none;">
                    <section class="panel">
                        <header class="panel-heading">
                          Header Main Menu Management<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                    ...
                    <fieldset>
                      <div class="form-group">
                        ...
                        <div class="left-box">
                          ...
                          <input type="text" class="validate[required] form-control placeholder" name="url_link" id="url_link" value=" <?php echo $row['url_link'] ; ?>" placeholder="" data-bind="value: name" /> 
                        </div>
                      </div>
					  ...
					  <!--  <div class="form-group">
                        <div class="left-box">
                          ...
                          <input type="file" class="validate[required] form-control placeholder" name="icon" id="icon"  placeholder="" data-bind="value: name" /> 
                        </div>
                      </div> -->
