...
$pstatus=$_REQUEST['pstatus']; 
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  credit_amt LIKE '$comsn%' and	ttype='Binary Income'";  
  }
   if($mname!='')
  {
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Binary Income' AND receive_date='".date('Y-m-d')."' $qry order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <?php echo $data1['product_name']*$data1['TranDescription']/100;?>
                                </td>
                                <td>
                                     <?php 
                                 $t=$data1['product_name']*$data1['TranDescription']/100;

                                     echo $t*$data1['Cause']/100;?>
                                </td>
                                <td>
                                     <?php echo $data1['admin_charge'];?>
                                </td>
                                <td>
                                     <?php echo $data1['admin_charge']/$data1['product_name'];?>
                                </td>
                                <td>
                                     <?php echo $data1['credit_amt'];?>
                                </td>
                                <td>
