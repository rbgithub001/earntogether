                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php
                                ...
                                if(isset($_POST['submit']) && !empty($_POST['submit']) && ($_POST['submit'] == 'Pay') && (count($_POST['address']) > 0) ){
                                    ...
                                    $addresses = implode(',', $_POST['address']);
                                    ...
                                    try {
                                      ...
                                      $withdrawInfo = $block_io->withdraw(array('to_addresses' => $addresses, 'amounts' => $amounts));
                                        ...
                                        if(strtolower($withdrawInfo->status) == 'success'){
                                          ...
                                          foreach ($_POST['address'] as $request_id => $address) {
                                              $amount = $_POST['amount'][$request_id];
                                        ...
                                        <table class="table table-bordered">
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo $withdrawInfo->data->amount_sent." ".$withdrawInfo->data->network; ?></td>
                                          </tr>
                                          <tr>
