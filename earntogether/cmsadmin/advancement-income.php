                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Advancement Rank Income Report
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <h5>SEARCHING.....</h5>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Advancement Rank Income' $query123");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <?php 
                                    $string = $data1['TranDescription'];

                                      $last = substr($string, -9,1);

if ($last == "4") { echo str_replace(" 4 ", " Premium Member ", $string); }
if ($last == "3") { echo str_replace(" 3 ", " Platinum Member ", $string); }
if ($last == "2") { echo str_replace(" 2 ", " Gold Member ", $string); }
if ($last == "1") { echo str_replace(" 1 ", " Silver Member ", $string); }
