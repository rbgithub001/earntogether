...
$pstatus=$_REQUEST['pstatus']; 
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  request_amount LIKE '$comsn%' ";  
  }
   if($mname!='')
  {
  ...
  if($pstatus!='')
  {
    $selectquery=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select user_id from user_registration where binary_pos='".$pstatus."'"));
$query123[]=" and  user_id='".$selectquery['user_id']."'";  
  }
  if($frm!='' && $til!='')
  {
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from withdraw_request where 1 $qry order by id desc");
                                  ...
                                  while($data1=mysqli_fetch_array($data))
                                    { 
                                     $total=$total+$data1['request_amount'];
                                        ?>
                            <tr style="text-align:center;">
                                <td>
                                    <?php echo $i;?>
                                ...
                                <td>
                                     <?php echo number_format($data1['request_amount'],2);?>
                                </td>
                                <td>
                                  <?php echo $data1['acc_number'];?>
                                </td>
                               <td>
                                    <?php
