...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where master_account='$m_id'");
...
<a href="view_masteracct.php?id=<?php echo $data1['user_id'];?>"> <img src="images/viewdata.png" style="width:30px; height:30px;"></a>
                                </td>
 -->
