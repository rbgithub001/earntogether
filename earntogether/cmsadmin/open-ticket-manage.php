                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from tickets where status=0");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                 ...
                                 <td>
                                 <?php echo "Not Resonded"; ?>
                                </td>
                                 <td>&nbsp;
                  <span style="margin-left:5px;"><a href="open-tickets-response.php?id=<?php echo $banners['id'];?>" title="View Detail">Edit</a></span>
