    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php  
                               ...
                               // echo $seller_id;
                                  ...
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"],"select * from amount_detail where seller_id='$seller_id' ");
                            ...
                            <tr style="text-align:center;">
                              <!--  <td>
                                ...
                                <td>
                                  ...
                                  <td>
                                    <?php echo $data1['total_invoice_cv'];?>
                                </td>
                               ...
                               <!-- <td>
                                    <a href="vender-history.php?id=<?php echo $data1['id'];?>">Edit</a>
