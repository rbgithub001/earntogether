                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                  Member Package Report (Admin Activation)
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from lifejacket_subscription where pay_type='Admin Activation' $qry order by id desc");
                                  while($data1=mysqli_fetch_array($data))
                                    { 
