...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['pid'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_contactus where id='".$id."'");
...
$str="update manage_contactus set logo_title='".$title."',logo_desc='".$content."',logo_name='".$img."',date='".$date."' WHERE id='".$id."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_contactus.php?id=". $id."&msg=Details Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            UPDATE CONTACT US PAGE <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
