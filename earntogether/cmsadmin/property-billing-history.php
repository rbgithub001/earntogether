...
<!--                                </span>-->
                     ...
                     <?php
                      ...
                      $ctotal_amount=0;
                      $ctotal_amount=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from billing_detail $qry order by am_id desc");
                      while($data1=mysqli_fetch_array($data))
                      {
                          
                           $userdetails=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"],"select * from user_registration where user_id='".$data1['seller_id']."'"));
                    
                        $ctotal_amount=$ctotal_amount+$data1['total_amount'];
                        $net_amount=$net_amount+$data1['net_amount'];
                     ...
                     ?>
                      ...
                      <tr  style="text-align:center;">
                        ...
                        <td><?php echo $userdetails['first_name'].' '.$userdetails['last_name'];?></td>
                         ...
                         <td><?=CURRENCY; ?> <?php echo $data1['actual_property_amount'];?></td>
                         <td><?=CURRENCY; ?> <?php echo $data1['net_amount'];?></td>
                         <td><?=CURRENCY; ?> <?php echo $data1['total_amount'];?></td>
                         <td><?php echo $data1['commisiion_perc'];?>%</td>
                         
                          <td><?=CURRENCY; ?> <?php echo $data1['rel_com_amt'];?></td>
                         <td><?=CURRENCY; ?> <?php echo $data1['total_amount']-$data1['rel_com_amt'];?></td>

                          <td><?php echo $data1['payment_type'];?></td>
                        <td><?php echo $data1['payment_date'];?></td>
                       <!--<td><?php echo $data1['seller_id'];?></td>-->
                       
                           <td>
                               <a style="color:#34379e" href="invoice_details.php?invoice_no=<?php echo $data1['invoice_no'];?>">View Invoice</a>
                               </td>
                      </tr>
                      ...
                      <?php $i++;} ?>
                           ...
                           <td style="font-weight:bold;text-align:center;"><h4>Total Property Amount= <?php echo CURRENCY.' '. $net_amount; ?></h4></h4></td>
