...
<html lang="en">
  <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>SamZuga Ewallet Payment</title>
    ...
    <div class="animsition">
      ...
      <main class="login-container">
        ...
        <div class="panel-container">
          ...
          <img src="../images/logo.png" class="big-logo" style="width: 220px;">
              <h2>Pay Via Ewallet</h2>
            </header>
            <div class="panel-body">
              <form action="../action.php" method="post">
                 <input type="hidden" name="action" value="registrationwithEwallet" />
            <input type="hidden" name="payment_method" value="Ewallet"  required >
                ...
                <div class="form-group">
                  <label for="password">Sponsor Login Password</label> 
                  <input type="password" class="form-control" id="password" placeholder="Password" name="password"  required>
                </div>
                  <div class="form-group">
                  <label for="password">Sponsor Transaction Password</label> 
                  <input type="password" class="form-control" id="tcode" placeholder="Password" name="tcode"  required>
                </div>
                  <div class="form-group">
                  <label for="password">Select Wallet Type</label> 
                  <select class="form-control" id="wallet_type" name="wallet_type"  required>
                    <option value="final_e_wallet">Register Wallet</option>
                      <option value="commission_e_wallet">Cashout Wallet</option> 
                  </select>
                </div>
