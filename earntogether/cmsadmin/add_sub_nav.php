...
function adImageUpload($image, $cnt, $pathss)
  ...
  $img1=adImageUpload($_FILES['icon'], "1", $mainImagePath);

  
		
   $sql="insert into Sub_header_menu SET  main_id = ' ".$main_id ."' ,  menu_name = '".$menu_name."' , page_link ='".$page_link."' , post_date= '".$date."', description ='".$description."'  " ;    
            ...
            <div class="row">
                <div class="col-lg-7 center-block" style="float:none;">
                    <section class="panel">
						...
						<?php  $sql1=mysqli_query($GLOBALS["___mysqli_ston"], "select * from  manage_slider where id ='$id' ");
				 ...
				 <form action="" class="validate" method="post" id='form1' enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="left-box">
                          ...
                          <input type="text" class="validate[required] form-control placeholder" name="menu_name" id="menu_name" value=" <?php echo $row[main_heading] ; ?>"  placeholder="Your Name" data-bind="value: name" />
                        ...
                        <div class="left-box">
                          ...
                          <input type="text" class="validate[required] form-control placeholder" name="page_link" id="page_link"  placeholder="" data-bind="value: name" /> 
                        </div>
                      </div>
				    ...
				    <div class="form-group">
                        <div class="left-box">
                          ...
                          <select class="validate[required] form-control placeholder" required name="main_id" />
