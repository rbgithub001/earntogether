...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_frontservice where id='".$id."'");
...
$str="update manage_frontservice set logo_title='".$title."',logo_desc='".$content."',date='".$date."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_frontservices.php?id=". $id."&msg=Data Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            UPDATE FRONT OUR SERVICES<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Our services Title</label>
                                    <div class="col-lg-10">
                                ...
                                <!--  <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload logo:</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Our services Description</label>
                                    <div class="col-lg-10">
