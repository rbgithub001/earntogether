        ...
        <div class="body-content" >
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="export_recent_trnc_report.php" class="btn btn-success">Export in excel</a>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where 1 $qry order by id desc");
