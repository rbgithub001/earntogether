...
if($frm!='' && $til!='')
{
$query123="and  issue_date>='$fdate' and   issue_date<='$edate' ";  
        ...
        <div class="body-content" >
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="export_issued_report.php" class="btn btn-success">Export in excel</a>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
            $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where (issued='YES' || issued='UPG') $query123");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $data1['issued'];?>
                                </td>
                                <td>
                                    <?php echo $data1['issue_date'];?>
                                </td>
                                  <td>
                                    <?php echo $data1['product_type'];?>
                                </td>
