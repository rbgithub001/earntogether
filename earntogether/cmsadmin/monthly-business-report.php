                                  ...
                                  while($data1=mysqli_fetch_array($data))
                                    {
                                        ...
                                        //$businessamt = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(total_invoice_cv) as invcv from amount_detail where purchase_date between '$startdate' and '$enddate' and  user_id='$uid' and closed_status='0'"));
                                        ...
                                        $cofoundertot = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='1' and ttype='Co-founder Income'"));
                                        $crddbt = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='1' and ttype=('Level Income' || 'Co-founder Income')"));
                                        $crdamt = $crddbt['crdamt'];
                                        
                                        //$selfcrddbt = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='1' and ttype='Level Income' and Cause='0'"));
                                           if($crdamt>0)  {   
                                        ?>
                            <tr style="text-align:center;">
                                <td>
                                ...
                                <!--<td><?php echo $selfcrddbt['crdamt'] ? number_format($selfcrddbt['crdamt'],2) : '0.00';?></td>-->
                                  <td><?php echo number_format($leveltot['crdamt'],2);?> </td>
                                   <?php 
                                //$selfcrdamt = $selfcrddbt['crdamt'];
                                //$total1= $selfcrdamt; ?>
                                 <td><?php //$total= $crdamt+$tot2+$total1; 
                                 $total= $crdamt;
                                 echo number_format($total,2);?></td>
                                
                                
                               <?php
                               //$total_sum1 = $total_sum1+$total1;
