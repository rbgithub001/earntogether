                           ...
                           <div>
                              ...
                              <div class="table-responsive">
                                  <form name="widget" method="post"  action="">
                                   <div class="search-name" style="float: right; margin-bottom:20px; margin-right: 7px;"> <strong> Search Here</strong> <strong>:</strong>
                        ...
                        <table border="1px" class="table table-bordered table-hover role" style="background:#FFF; border-color:#000;">
                          ...
                          <tbody>
                            <?php
                              ...
                              $config_query_record="SELECT user_id,username,first_name,last_name,password,t_code from user_registration ";
...
$sno=$sno+1;
                          ...
                          <tr style="text-align:center;">
                                ...
                                <td>
                                 ...
                                 <td>
                                    <?php echo $row_config['password'];?>
                                </td>
                                <td>
                                    <?php echo $row_config['t_code'];?>
                                </td>
