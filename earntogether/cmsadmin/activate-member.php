                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                              Approved Proof List <span style="float:right;color:green;"><?php echo @$_GET['msg'];?></span>
                            ...
                            <tbody>
                            <?php 
                               $data_row=mysqli_query($GLOBALS["___mysqli_ston"], "select * from id_proof_list where status='1' order by id desc");
                               $i=1;
