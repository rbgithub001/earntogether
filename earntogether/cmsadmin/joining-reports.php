                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                 ...
                                 <td>
                                    ...
                                    <?php $user=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from lifejacket_subscription where user_id='".$data1['user_id']."'")); $user['package'];?>
                                
                                <td><?php $user1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from status_maintenance where id='".$user['package']."'")); echo $user1['name'];?>
                                    
                                </td>
                                <td>
                                    <?php echo $user1['amount'];?>
                                </td>
