...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from currency_manage where id='".$id."'");
...
$str="update currency_manage set from_currency='".$from."', to_currency='".$to."', exchange_rate='".$exchnage_rate."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:edit_currency.php?id=". $id."&msg=Currency Information Updated Successfully !");
}}
