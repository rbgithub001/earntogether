...
$name=$_POST['name'];
$link=$_POST['link'];
$str="insert into categories set name='".$name."',link='".$link."', date='".date('Y-m-d')."', status='0'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");
if($res)
{
header("location:add_category.php?msg=New Category Added Successfully !");
}}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Categories Manage<span style="float:right;color:GREEN;font-size:15px!important"><?php echo @$_GET['msg'];?></span>
                        </header>
