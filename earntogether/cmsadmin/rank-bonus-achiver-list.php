...
<body class="sticky-header">
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Royality Income Achiever Report
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from rank_achiever_new order by id desc");
