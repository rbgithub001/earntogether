...
<body class="sticky-header">
 ...
 <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="export_approved_payment.php" class="btn btn-success">export in excel</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from paymentproof where status='1'");
