                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add Events <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        
                       
                        <div class="panel-body">
                            <form class="form-horizontal" name="form-s" role="form" method="post" action="insert_ourclients.php" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Caption</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter Caption" required value="" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="url" class="form-control" placeholder="Enter URL" required value="" >
