        ...
        <div class="body-content" >
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel" >
                <header class="panel-heading main-heading">
                  <h4 class="panel-title" style="color: #fff;">Purchase Invoices</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $grandrevenue=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from amount_detail order by am_id desc");
