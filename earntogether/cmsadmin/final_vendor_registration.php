                        ...
                        <div class="row">
                            <div class="col-md-12 group" style="padding-left:30px;" id="repeatCols" >
                               <header class="text-center">
                                         <h3> Vendor Registration Completed Successfully. </h3>
                                         <p style="margin-top:35px;"><button class="btn btn-default2 btn-block" style="color:green;">You are being redirected to the vendor list in <span id="countdowntimer">3 </span> seconds.</button></p>
                               </header>  
...
<script>
         setTimeout(function(){
            window.location.href = 'http://182.76.237.238/~syscheck/e-marketing/controlpanel/poc_member_list.php';
         }, 3000);
</script>
