...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Roi Income' $qry order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <?php echo number_format($data1['credit_amt'],8).' ('.$data1['product_name'].')';?>
                                </td>

                                 <td>
                                     <?php echo number_format($data1['Cause'],8);?>
                                </td>
                                <td>
