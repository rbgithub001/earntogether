...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from ebook where id='".$id."'");
...
$title=$_REQUEST['title'];
 ...
 $old_image=$_POST['old_image'];
  $image=time()."main_".$_FILES['file_name']['name'];
    $uploads_dir = 'images';
...
$str="update ebook set logo_title='".$title."',logo_desc='".$content."',logo_name='".$img."',date='".$date."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_ebook.php?id=". $id."&msg=Ebook Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Update Ebook<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Ebook title</label>
                                    <div class="col-lg-10">
                                 ...
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload Ebook:</label>
                                    <div class="col-lg-10">
                                        <input name="file_name" type="file"  value="<?php echo $row['logo_name'];?>" class="form-control" placeholder="Enter New Password"   ></br>
                                        <h2><th style="text-align:center;font-weight:bold;"> <a href="images/<?php echo $row['logo_name'];?>" target="_blank"> <?php echo $row['logo_name'];?></a></th></h2>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input name="old_image" type="hidden"  value="<?php echo $row['logo_name'];?>"/>
                                ...
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Ebook Description</label>
                                    <div class="col-lg-10">
