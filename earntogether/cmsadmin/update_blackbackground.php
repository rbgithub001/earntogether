...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_blackbackground where id='".$id."'");
...
$str="update manage_blackbackground set logo_title='".$title."',logo_desc='".$content."',logo_name='".$logo_name."',date='".$date."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_blackbackground.php?id=". $id."&msg=Data Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Update <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter New title" required value="<?php echo $row['logo_title'];?>" >
                                       
                                    </div>
                                </div>
                               <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sub Title:</label>
                                    <div class="col-lg-10">
                                        <input name="logo_name" type="text"  value="<?php echo $row['logo_name'];?>" class="form-control" placeholder="Enter New heading"   ></br>
