...
$shipmode=$_REQUEST['ship_mode'];  
  ...
  $query123="and TranDescription='$shipmode'";  
        ...
        <div class="body-content" >
            ...
            <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="export_total_credit_amount.php" class="btn btn-success">Export in excel</a>
...
<select style="line-height: 24px;" name="ship_mode"  id="ship_mode">
                   
                    <option value="" selected="selected" >-- Choose Description --</option>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM credit_debit WHERE (TranDescription='Bank Transfer' || TranDescription='NETS' || TranDescription='Cash' || TranDescription='VISA/MASTER' ||  TranDescription='Paypal' ||  TranDescription='OTHERS' ||  TranDescription='Credit Adjustment' ) $query123");
                            ...
                            <tr style="text-align:center;">
                               ...
                               <!--  <td>
                                ...
                                <td>
                                     <?php echo $data1['TranDescription'];?>
                                </td>
                                <td>
                      ...
                      <td></td>
                      <td></td>
                      <td style="font-weight:bold;text-align:center;"><h4>Total Credit Amount = </h4></td>
