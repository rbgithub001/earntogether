...
move_uploaded_file($_FILES['image']['tmp_name'],"banner_images/".$file_name);
        ...
        list($width, $height) = @getimagesize("banner_images/".$file_name);

                
          // create small image dimension is 165*165.
          $ImageCreate_obj->new_image_name = $small_image;
          $ImageCreate_obj->new_image_width = height1;
          $ImageCreate_obj->new_image_height =height1;
...
mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `manage_slider` (`id`,`main_heading`, `url`,`actual_image`, `image`, `m_image`, `l_image`,`banner_image`,`status`,`date`) VALUES (NULL, '$main_heading', '$url','$file_name', '$small_image', '$medium_image','$large_image','$banner_image','$status','".date('Y-m-d')."' )");



header("location:manage_banner.php?msg= Added Successfully !");
}
...
$(document).ready(function() {
    $('#height').keyup(function(ev){
        var height1 = $('#height').val();
        $('#height1').html((height1).toFixed());
      // $('#height').val(height1);
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                         ...
                         <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="url" class="form-control" placeholder="Enter url"  value="" >
                         ...
                         <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Height</label>
                                    <div class="col-lg-10">
                                        <input type="number" tabindex="1" name="height" class="form-control" placeholder="Enter height"  value="" id="height">
                       ...
                       <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Width</label>
                                    <div class="col-lg-10">
                                        <input type="number" name="width" class="form-control" placeholder="Enter width"  value="" id="width" >
