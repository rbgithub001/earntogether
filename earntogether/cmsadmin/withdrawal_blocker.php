...
if(isset($_POST['Add']))
{
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set withdraw_status='$bstatus' where user_id='".$_POST['userid']."'");
   

   header("location:withdrawal_blocker.php?msg=Withdrawal Request Blocked Status Updated Successfully..!");
  exit;
  }
  else{
     header("location:withdrawal_blocker.php?msg=Userid and username not match");
  exit;
  }
}
?><!DOCTYPE html>
