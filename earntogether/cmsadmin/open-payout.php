                            ...
                            <?php 
                                 $i=1;
                                  ...
                                  while($data1=mysqli_fetch_array($data)){
                                        ...
                                        $leveltot = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='1'"));
                                        ...
                                        $recivId = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where status='1'"));
