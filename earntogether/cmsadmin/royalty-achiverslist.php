...
<body class="sticky-header">
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from reward_status order by id ASC");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <?php echo $data1['rank_name'];?>
                                </td>
                                <td>
                                  <?php if($data1['rank_status'] == 1){ echo '<i class="fa fa-check"></i>';}else{ echo '<i class="fa fa-times"></i>';}?>
                                </td>
                              
                                <td>
                                     <?php if($data1['reward_status'] == 1){ echo '<i class="fa fa-check"></i>';}else{ echo '<i class="fa fa-times"></i>';}?>
                                </td>
                                 <td>
                                     <?php echo $data1['achieved_date'];?>
                                </td>
