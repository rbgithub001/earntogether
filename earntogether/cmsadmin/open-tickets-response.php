...
header("Location:close-ticket-manage.php");
}
else
{
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Open Ticket Response<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
...
<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea name="response" id="editor" class="form-control"></textarea>
