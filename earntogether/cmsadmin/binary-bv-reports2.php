...
$username=$_REQUEST['id'];  
  ...
  $query123=" where description='Product Purchase Amount' and income_id='$username'";  
    
  }
  
if($frm!='' && $til!='')
{
$query123="where description='Product Purchase Amount' and date>='$fdate' and   date<='$edate' ";  
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            // exit();
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_bv_history $query123");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $data1['income_id'];?>
                                </td>
                                <td>
                                    <?php echo $data1['downline_id'];?>
                                </td>
                                <td>
                                  <?php echo $data1['bv'];?>
                                </td>
