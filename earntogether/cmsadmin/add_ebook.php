...
$str="insert into ebook set logo_title='".$title."',logo_desc='".$content."',logo_name='".$image."',date='".$date."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_ebook.php?id=". $id."&msg=Ebook Uploaded Successfully !");
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        Upload Ebook<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
