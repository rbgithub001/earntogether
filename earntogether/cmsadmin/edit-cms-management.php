...
if(isset($_POST['Add']))
{
   ...
   mysqli_query($GLOBALS["___mysqli_ston"], "update contactdetail set description='$content', posted_date='".date('Y-m-d')."' where id='$id'");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Policy Manage<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from contactdetail where id='".$_GET['id']."'"));?> <?php
                $text = '' ;
                            if(isset($data['description']))
                            {
                               $text = stripslashes($data['description']);
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea name="content" id="editor2" class="form-control"><?php echo $texts;?></textarea>
