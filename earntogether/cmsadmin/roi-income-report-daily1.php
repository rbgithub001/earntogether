...
$pstatus=$_REQUEST['pstatus']; 
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  credit_amt LIKE '$comsn%' and	ttype='Roi Income'";  
  }
   if($mname!='')
  {
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Islamic investment Closing Report
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Roi Income' AND receive_date='".date('Y-m-d')."' and TranDescription='Sharia Investment' $qry order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <?php echo number_format($data1['credit_amt'],5).' ('.$data1['product_name'].' % )';?>
                                </td>

                                 <td>
                                     <?php echo number_format($data1['Cause'],5);?>
                                </td>
                                <td>
