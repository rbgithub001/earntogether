...
<!--</form>-->
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `credit_debit` WHERE ttype='Self Income' ");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <!--</td>-->
                                <!--<td>-->
                                <!--    <?php $user=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['sender_id']."'")); echo $user['username'];?>-->
                                <!--</td>-->
                                <td>
                                    <?php $recusers=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['receiver_id']."'")); echo $recusers['user_id'];?>

                                </td>
                                <td>
                                    <?php echo $recusers['username'];?>
                                </td>
                                <td><?php echo $data1['total_invesment_amount'];?></td>
                                 <td>
                                  <?php echo $data1['percent'];?>
                                </td>
                                <td>
                                  <?php echo $data1['commis_amt'];?>
                                </td>
                                <td>
                      ...
                      <td><span><h4> <? echo CURRENCY ; ?> <?php echo $total; ?></h4></span></td>
                      </tr>
