...
<body class="sticky-header">
                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                 Approved Requests<br><center><b style="color: green;"><?php echo @$_GET['msg'];?></b></center>
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"],"select * from user_request WHERE status='1' $query123");
