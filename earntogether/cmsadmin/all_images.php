            ...
            <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="add_image.php" class="btn btn-success">Upload New Images</a>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from images ");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                     <img src="images/<?php echo $data1['image'];?>" width="85px;" height="60px;">
                                </td>
                                ...
                                <td>
                                     <a href="edit_image.php?edit_image=<?php echo $data1['id']?>">Edit</a>
                                </td>
                                <td>
                                     <a href="image_delete.php?delete=<?php echo $data1['id']?>" onclick="return confirm('Are You Sure,Delete This Image Permanantly')">Delete</a>
                                </td>
                            </tr>
                            <?php $i++;} ?>
