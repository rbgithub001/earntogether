...
<body class="sticky-header">
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"],"select * from user_request WHERE status='2' $query123");
                                  while($data1=mysqli_fetch_array($data))
                                    {
                                        $pname=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"],"SELECT name FROM status_maintenance WHERE id='".$data1['package']."' "));
                                     ?>
                            <tr style="text-align:center;">
                                <td>
                                    <?php echo $i;?>
