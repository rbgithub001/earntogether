...
$project_name=$_POST['project_name'];
 ...
 if(!empty($pdffile)){
   ...
   $pdffile =$pdffile;
    ...
    header("location:add_project.php?msg1=Project PDF Required !");

 }

$str="insert into projects (category_id,project_name,pdf_link,date) values('$category','$project_name','$pdffile','$date')";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:edit_project.php?id=". $id."&msg=Project Information Added Successfully !");
}
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                       <input required type="text" name="project_name" class="form-control" placeholder="Project Name">
                                    </div>
                                </div>
                                <div class="form-group">
