                ...
                <div class="col-lg-6">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                          <?php $id=$_GET['id'];$data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from tickets where id='$id'"));?>
                          <table class="table table-responsive">
                            <tr><td>Ticket Number :</td><td><?php echo $data['ticket_no']; ?></td></tr>
                             <tr><td>User Name :</td><td><?php echo $data['user_name']; ?></td></tr>
                              <tr><td>User Id :</td><td><?php echo $data['user_id']; ?></td></tr>
                               <tr><td>Category :</td><td><?php echo $data['tasktype']; ?></td></tr>
                                <tr><td>Subject :</td><td><?php echo $data['subject']; ?></td></tr>
                                 <tr><td>Posted Date :</td><td><?php echo $data['t_date']; ?></td></tr>
                                  <tr><td>Description :</td><td><?php echo $data['description']; ?></td></tr>
                                  <tr><td>Response :</td><td><?php echo $data['response']; ?></td></tr>
                          </table>
                        </div>
                    </section>
                </div>
