...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_reginfo where id='".$id."'");
...
$str="update manage_reginfo set logo_title='".$title."',logo_desc='".$content."',date='".$date."',logo_name='".$subtitle."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_registration.php?id=". $id."&msg=Data Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Update Registration page<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter Title" required value="<?php echo $row['logo_title'];?>" >
                                       
                                    </div>
                                </div>
                            <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sub Title logo:</label>
                                    <div class="col-lg-10">
                                        <input name="subtitle" type="text"  value="<?php echo $row['logo_name'];?>" class="form-control" placeholder="Enter sub title"   ></br>
