                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add News <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        
                       
                        <div class="panel-body">
                            <form class="form-horizontal" name="form-s" role="form" method="post" action="insert_news.php" enctype="multipart/form-data">
