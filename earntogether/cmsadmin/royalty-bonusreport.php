...
$pstatus=$_REQUEST['pstatus']; 
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  credit_amt LIKE '$comsn%' and	ttype='Royalty Bonus'";  
  }
   if($mname!='')
  {
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Royalty Bonus' $qry order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $data1['total_invesment_amount'];?>
                                </td>
                                <td>
