...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['pid'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_recentpost where id='".$id."'");
...
$str="update manage_recentpost set logo_title='".$title."',logo_desc='".$content."',logo_name='".$img."',date='".$date."' WHERE id='".$id."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_recentpost.php?id=". $id."&msg=Recent post Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Update Recent Post<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" name="form23" action="" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Recent Post title</label>
                                    <div class="col-lg-10">
                                 ...
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Recent Post Image:</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Recent Post Description</label>
                                    <div class="col-lg-10">
