...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from sub_categories where sub_category_id='".$id."'");
...
$str="update sub_categories set name='".$name."' WHERE sub_category_id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:edit_sub_categories.php?id=". $id."&msg=Category Information Updated Successfully !");
}}
