...
if(isset($_POST['Add']))
{
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set reg_status='$bstatus' where user_id='".$_POST['userid']."'");
   

   header("location:registration_blocker.php?msg=registration Blocked Status Updated Successfully..!");
  exit;
  }
  else{
     header("location:registration_blocker.php?msg=Userid and username not match");
  exit;
  }
}
?><!DOCTYPE html>
