...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['pid'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_ourclients where id='".$id."'");
  $row=mysqli_fetch_assoc($sql);
  
date_default_timezone_set("Africa/Singapore");
...
$str="update manage_ourclients set logo_title='".$title."',url='".$url."',logo_desc='".$content."',logo_name='".$img."',date='".$date."' WHERE id='".$id."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_clients.php?id=". $id."&msg1= Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Update Events<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        
                       
                        <div class="panel-body">
                            <form class="form-horizontal" name="form23" action="" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Caption</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter New Password" required value="<?php echo $row['logo_title'];?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="url" class="form-control" placeholder="Enter New url" required value="<?php echo $row['url'];?>" >
                                       
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload Picture:</label>
                                    <div class="col-lg-10">
                                        <input  type="file" name="file_name"   value="<?php echo $row['logo_name'];?>" class="form-control" placeholder="Enter New Password"   ></br>
                                        <img src="images/<?php echo $row['logo_name'];?>" width="184px" height="46px"/>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="hidden" name="old_image"   value="<?php echo $row['logo_name'];?>"/>
                               ...
                               <!--  <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea name="content" id="editor2" class="form-control"><?php echo $row['logo_desc'];?></textarea>
