...
function _LoginUserCode()
{
    ...
    exit;*/
		...
		header("location:userpanel/login.php");*/
					echo "<script>window.location.href='userpanel/login.php?msg=Password does not match!'</script>";
					exit;
				}
...
function userid()
{
	...
	$pre_userid = "ET" . rand(100000, 999999);
...
function _UserRegistration()
{
	...
	if (1 == 1) {
		...
		$insert_array = array(
			'user_id' => $user_id, 'first_name' => $firstname, 'last_name' => $lastname,
...
function _UserRegistrationAdmin()
{
	...
	// if($sponsorid=='123456'){
	$insert_array = array(
		'user_id' => $user_id, 'first_name' => $firstname, 'last_name' => $lastname, 'ref_id' => $sponsorid, 'nom_id' => $sponsorid,
...
function  _CheckUserEwalletBalance()
{
	...
	$payment_type = $_POST['payment_method'];
	print_r("<br/>");
	$username = $_POST['pay_username'];
	print_r("<br/>");
	$t_password = $_POST['pay_password'];
	print_r("<br/>");
	$total_amount = $_SESSION['lamount'];
	print_r("<br/>");
...
function _PocRegistration()
{
	...
	if ($user_id != '') {
		$insert_array = array(
			'user_id' => $user_id, 'file' => $dd, 'username' => $username, 'password' => $password, 'first_name' => $firstname, 'description' => $description,
