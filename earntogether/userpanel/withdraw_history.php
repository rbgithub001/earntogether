...
<html lang="en">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h4 class="m-t-none m-b text-primary-lt font-thin-bold inline font-semi-bold"><b>WITHDRAWAL HISTORY</b></h4>
                        ...
                        <table class="table datatable">
                                      <thead>
                                        ...
                                        <?php
                                             ...
                                             $i=1;
                                              $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from withdraw_request where user_id='$userid'");
  ...
  <td><?php echo $data1['bank_nm'];?>-<?php echo $data1['acc_name'];?></td>
                                                   </tr>
                                                <?php $i++;} ?>
                                        </tbody>
                                </table>
