...
<html lang="en">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Fund Transfer / Added  Transaction History</h4>
                </header>
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and (ttype='Fund Transfer' and product_name='Fund Transfer') or (ttype='Fund Added') or (ttype='External Fund Transfer') order by id desc");
 ...
 <?php $data112=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['user_id']."'"));?>
                        <td><?php echo $data112['first_name']." ".$data112['last_name'];?></td>
                         <td><?php echo $data112['username'];?></td>
                         <?php } ?>
