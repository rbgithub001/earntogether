          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <h4 class="m-t-none text-primary-lt font-thin-bold inline m-b font-semi-bold">RELEASED LEVEL INCOME REPORT</h4>
                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     <?php
                     //echo "select * from credit_debit where receiver_id='$userid' and ttype='Level Income' order by id desc";die;
                      $i=1;
                      $total=0;
                      $total1=0;
                      $tt = 0;
                          
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where receiver_id='$userid' and ttype='Level Income' order by id desc");
                    ...
                    <!--    <td><?php echo '5';?> %</td>-->
                     <!--   <td><?php echo $data1['admin_charge']; // $relecom ?><?php //echo $tds; ?></td>-->
                       ...
                       // echo $finalpay;?></td>
                         ...
                         <!--<td><?php if($data1['status']==0) echo "Paid"; else echo "Pending"; ?></td>-->
                    </tr>
