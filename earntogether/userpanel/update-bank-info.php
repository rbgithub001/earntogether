...
mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set acc_name='$first21', bank_nm='$first23', branch_nm='$first24', ac_no='$first22', swift_code='$first25', bank_state='$bank_state' where user_id='$userid'");
header("location:update-bank-info.php?msg=Bank Detail Updated Successfully !");
}
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <section class="panel panel-primary">
                <h4 class="m-t-none text-primary-lt font-thin-bold inline m-b font-semi-bold">Update Bank Information</h4>
                ...
                <div class="panel-body">
                 ...
                 <div class="form-group col-md-6 no-left-padding">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="Account1" value="<?php echo $f['acc_name'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
                  ...
                  <div class="form-group col-md-6 no-left-padding">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="Account3" value="<?php echo $f['bank_nm'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="Account5" value="<?php echo $f['swift_code'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
                    <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputAddress">Bank State</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="bank_state" value="<?php echo $f['bank_state'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
                    <div class="form-group col-md-6 no-left-padding">
                      <label for="exampleInputAddress">Bank Branch</label>
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="Account4" value="<?php echo $f['branch_nm'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-md-6 no-left-padding">
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" name="Account2" value="<?php echo $f['ac_no'];?>" class="form-control" id="exampleInputAddress" required>
                      </div>
                    </div>
