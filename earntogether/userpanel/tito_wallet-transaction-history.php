          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                  <div class="row">
                  <div class="col-lg-6">
                    <h4 class="m-t-none m-b text-primary-lt font-thin-bold inline font-semi-bold">Bonus Wallet Transaction History</h4>
                </div>
                <div class="col-lg-6 text-right">
                    <?php $tito_wallet=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select amount from final_e_wallet where user_id='$userid'"));
$tito_wallet_amount=$tito_wallet['amount']; ?>
                    <label style="font-weight:600;">Wallet Balance : </label> <?php echo 'SAR '.number_format($tito_wallet_amount,2);?>
                </div>
                </div>
                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ewallet_used_by='E Wallet' order by id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <td><?php if($data1['sender_id'] == 'Admin'){ echo 'Admin';}else{echo $data11['first_name']." ".$data11['last_name'];}?></td>
