    ...
    <div class="animsition">  
      ...
      <main id="playground">
        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-8">
            <h1>Inbox</h1>
            <p class="lead">Message from <strong>Jon Snow</strong></p>
          </div>
        ...
        <div class="container-fluid">
          <div class="row">
              ...
              <section class="panel bordered-panel bordered-warning right-border">
                ...
                <div class="panel-body">
                  <div class="margin-bottom-15">
                    <a href="#" class="btn btn-danger btn-md">calendar-info.xls</a>
                  </div>
                  <div class="margin-bottom-15">
                    <a href="#" class="btn btn-danger btn-md">project-files.rar</a>
                  </div>
                  <div class="margin-bottom-15">
                    <a href="#" class="btn btn-danger btn-md">mydog.jpg</a>
                  </div>
                </div> <!-- / panel-body -->
              </section> <!-- / section -->

              <section class="panel bordered-panel bordered-primary right-border">
                <header class="panel-heading">
                  About <strong>Jon Snow</strong>
                </header>
                ...
                <div class="panel-body">
                  ...
                  <p>Etiam fermentum sollicitudin urna, tempor pellentesque neque semper in. Phasellus mauris orci, cursus in leo ac, iaculis volutpat velit</p>
                  <p>Vivamus viverra justo ac dui condimentum, eget bibendum lectus accumsan. Nulla facilisi. </p>

                  <a href="#" class="btn btn-primary">view profile</a>
                </div>
              </section> <!-- / section -->

              <a href="#" class="form-control btn btn-danger">View all John's messages</a>
            ...
            <div class="col-md-9 margin-bottom-30">
              <section class="panel">
                <header class="panel-heading">
                  <h3 class="panel-title">Product Information for your order from Amazon</h3>
                </header>
                ...
                <header class="panel-heading mail-sender">
                  ...
                  <div class="data-container pull-left">
                    <span class="from">John Snow</span>
                    <span class="email">&lt;johnsnow@candy-rocket.com&gt;</span>
                  </div>

                  <div class="btn-group pull-right">
                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <i class="ti-share-alt"></i> <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" role="menu">
                      <li><a href="#" class="">Reply</a></li>
                      <li><a href="#" class="">Forward</a></li>
                      <li class="divider"></li>
                      <li><a href="#" class="">Print</a></li>
                      <li><a href="#" class="">Delete</a></li>
                      <li class="divider"></li>
                      <li><a href="#" class="">Report Spam</a></li>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <p>Vivamus viverra justo ac dui condimentum, eget bibendum lectus accumsan. Nulla facilisi. Aliquam ac turpis tempor, elementum tellus at, tincidunt nulla. Nunc in libero erat. Proin efficitur posuere tellus vel porttitor. Donec euismod euismod odio et interdum. Nam accumsan leo quis metus mollis consequat. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.