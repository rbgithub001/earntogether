        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <form action="../post-action.php" method="post">
              ...
              <?php if (isset($_GET['msg'])) { ?> <div class="text-center" style="color:lightgreen; font-size:14px; font-weight:bold;"><span style="color:lightgreen;padding-left:10px;">
                    <?php
                      if ($_GET['msg'] == 'wrong') {
                        echo "Wrong Credential Details or account deactivated!";
                      } else if ($_GET['msg'] == 'logout') {
                        echo "You Are Logout!";
                      } else if ($_GET['msg'] == 'Wrong Security Code') {
