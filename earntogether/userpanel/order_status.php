...
$query3=mysqli_query($GLOBALS["___mysqli_ston"], "select price_in_usd, product_url, price_in_btc from invoices where invoice_id='".$invoice_id."'");
...
//$result->close();
//$stmt->close(); 
$query4=mysqli_query($GLOBALS["___mysqli_ston"], "select value from pending_invoice_payments where invoice_id ='".$invoice_id."'");
...
$query5=mysqli_query($GLOBALS["___mysqli_ston"], "select value from invoice_payments where invoice_id = '".$invoice_id."'");
