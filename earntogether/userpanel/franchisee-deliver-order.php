...
<html lang="en">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Delivered Invoices</h4>
                </header>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from  amount_detail where seller_id='$userid' and shipping_status='Delivered' order by am_id desc");
 ...
 echo $data1['payment_date'];?></td>
                         ...
                         <td> Delivered on <?php echo $data1['deliver_date'];?></td>
                      </tr>
