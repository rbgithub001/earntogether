                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      ...
                      // exit();
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from amount_detail where user_id='$userid' order by am_id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <td><a style="color:#34379e" href="shopping-invoice-detail.php?inv=<?php echo $data1['invoice_no'];?>"><?php echo $data1['invoice_no'];?></a></td>
