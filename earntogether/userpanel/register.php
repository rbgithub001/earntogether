                    ...
                    <section class="panel" style="width: 100%;max-width:100%;">
                        ...
                        <div class="panel-body">
                            <form name="registration" method="post" method="post" action="../post-action.php" id="registration" autocomplete='off'>
                                ...
                                <?php @$msg = $_SESSION['err'];
                                if (isset($_GET['msg'])) { ?>
                                    <div class="reg-header">
                                        <p style="color:#F00; text-align:center;"><br />
                                            <span style="color:red; text-align:center; font-weight:bold; font-size:15px;">
                                                <?php if ($msg == 'ist') {
                                                    echo "Register Successfully..! Please Check Your Email.";
                                                } else if ($msg == 'username') {
                                                    echo "Username Already Exists";
                                                } else if ($msg == 'sponsor') {
                                                    echo "Sponsor Not Exists or Wrong platform choosen by you";
                                                } else if ($msg == 'email') {
                                                    echo "Email Already Exists";
                                                } else if ($msg == 'username1') {
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="sponsorid" autocomplete="off" placeholder="Please Enter Referral ID / Username" id="sponsorid" value="<?php if ($_SESSION['referral'] != '') {
                                                                                                                                                                                                        echo $_SESSION['referral'];
                                                                                                                                                                                                    } else {
                                                                                                                                                                                                    } ?>" required>
                                                <!--<input type="text" class="form-control" placeholder="Referral ID" name="sponsorid" onblur="checkuser(this.value)" autocomplete="off" placeholder="Please Enter Referral ID / Username" id="sponsorid" title="Sponsor name" value="<?php // if($_SESSION['referral']!='') { echo $_SESSION['referral']; } else {} 
                                                                                                                                                                                                                                                                                        ?>" <?php // if($_SESSION[ 'referral']!='' ) { 
                                                                                                                                                                                                                                                                                            ?> readonly-->
                                                <!--<input type="text" class="form-control" placeholder="Referral ID" name="sponsorid" autocomplete="off" placeholder="Please Enter Referral ID / Username" id="sponsorid" title="Sponsor name" value="<?php if ($_SESSION['referral'] != '') {
                                                                                                                                                                                                                                                            echo $_SESSION['referral'];
                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                        } ?>" <?php if ($_SESSION['referral'] != '') { ?> readonly   <?php } ?> required>-->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <select class="form-control" name="country" id="country" required>
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $cnrty['id'] ?>" data="<?php echo $cnrty['phonecode'] ?>" <?php if ($cnrty['id'] == '160') {
                                                                                                                                                echo 'selected';
                                                                                                                                            } else {
                                                                                                                                            } ?>> <?php echo $cnrty['name'] ?>(<?php echo $cnrty['phonecode'] ?>)</option>
                                                    <?php } ?>
                                                </select>
                                                <span id="cntry"></span>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label for="term">
                                                    ...
                                                    <font class="bldf"><a href="#" target="_blank" style="color:#444;">Read & accept our Terms of Services</a></font>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
