...
$mid=rand('22222','55555');
  ...
  $rest=mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `customers` ( `user_id`,`ref_id`,`title`, `first_name`, `last_name`, `email`, `pancard`,`address`,`occupation`, `city`,`state`,`country`, `telephone`,`date`) VALUES ('$mid', '$userid','$title','$first_name', '$last_name', '$email', '$pancard', '$address','$occupation','$city','$state','$country','$contact', '".date('Y-m-d')."')");
  if($rest){
						...
						<div class="col-md-12">
							<div class="form-group">
							  <label for="exampleInputName">Pancard:</label>
							   <input type="text" class="form-control" id="txtPANNumber" name="pancard" maxlength="10" onchange="validatePanNumber(this)"  required />
