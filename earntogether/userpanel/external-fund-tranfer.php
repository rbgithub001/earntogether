...
?>
           ...
           <form name="bankinfo" method="post" action="external-fund-transfer-confirm.php">
              <section class="panel panel-primary">
                ...
                <h4 class="m-t-none text-primary-lt font-thin-bold inline font-semi-bold" ><b>EXTERNAL WALLET FUND TRANSFER</b></h4>
                
                <h4>Bonus Wallet : <?php echo "$" ?> <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from final_e_wallet where user_id='$userid'"));?><?php  echo number_format($_SESSION['rates']*$data['amount'],2);?>
                  </h4>
                  <h4>ROI Wallet : <?php echo "$" ?> <?php $data1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from roi_e_wallet where user_id='$userid'"));?><?php  echo number_format($_SESSION['rates']*$data1['amount'],2);?>
                  </h4>
                  <h4>Level Wallet : <?php echo "$" ?> <?php $data2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from level_e_wallet where user_id='$userid'"));?><?php  echo number_format($_SESSION['rates']*$data2['amount'],2);?>
                  </h4>
                ...
                <div class="panel-body">
                 ...
                 <div class="form-group">
                    ...
                    <select name="walletfrom" class="form-control" required>
                        ...
                        <option value="final_e_wallet">Bonus Wallet</option>
