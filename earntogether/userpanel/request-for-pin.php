 ...
 if(isset($_POST['submit']))
 {
   ...
   if ($filename12!='') {
    ...
    if($check == false) {
       ...
       header("location:request-for-pin.php?msg=File is not an image.");
       exit(); 
    }
...
&& $imageFileType != "gif") {
     ...
     header("location:request-for-pin.php?msg=Sorry, file not allowed.");
       exit();
}
  ...
  $amount = $_POST['amount'];
   ...
   mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `pin_paymentproof` (`id`, `user`, `bank`, `amount`, `tranno`, `paymentproof`, `posteddate`, `status`,`bank_name`,`payment_mode`,`amount_used`,`apply_for`,`usd`,`total_usd`,`wallet_type`) VALUES (NULL, '".$f['user_id']."', '$bank', '$amount', '$trannumber', '$filename12', '".date('Y-m-d')."', 'Pending', '$bank_name', '$payment_mode', '$amount_used','Algorithmic Request','$total_usd1','$total_usd','$wallet_type')");
   
   header("location:request-for-pin.php?msg=Algorithmic request submited successsfully!"); 
   exit;
 }
  ...
  <body class="">
   ...
   <?php include("sidebar.php");?>
      ...
      <?php include("top.php");?>
        ...
        <!-- PAGE TITLE -->
        <section id="example2" class="row">

          <div class="col-xs-9">
           <!--<strong>Payment Information</strong>-->
           <strong style="color: black;"><i class="ti-wallet"></i> Please request for algorithmic and after admin approval,You will receive algorithmic.</strong>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="box-effect">
              ...
              <section class="panel from-panel">
                <h4>Upload Payment Information</h4>
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                          <?php $algo_amount= mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_commision_percentage where id='1'")); ?>    
                      <label>Algorithmic  Amount</label>
                      <select required="required" name="amount111" id="ammm" class="form-control" />
                        <option value="">please select amount</option>
                       <option value="<?=$algo_amount['algo_amnt'];?>"><?php echo $algo_amount['algo_amnt'];?></option>
                      </select>
                      <input type="hidden" name="usdamount" required="" value="" class="" id="ammm1" style="width: 90px;" readonly>
                    </div>
                    ...
                    <div class="form-group">
                    <label>You need to send <b>(BTC)</b></label>
                    <input type="text" name="amount" class="form-control" value="" id="ammm11" readonly>
                    </div>

                    <div class="form-group">
                      <label>Payment Method</label>
                       <select class="form-control" name="payment_method" id="payment_method" class="form-control" required="">
                   ...
                   <div class="form-group" id="transactionid" style="display: none;"><!-- Enter Transaction / Reference / UTR Number -->
                   ...
                   <!-- <div class="form-group" id="banknumber">
                    ...
                    <div class="form-group" style="display: none;" id="transproof"><!-- Upload the payment proof -->
                      <label for="exampleInputAddress">Upload proof of payment</label>
                      <input type="file" class="form-control" name="uploadedfile">
                    </div>

                    <div class="form-group">
                      <input type="submit" name="submit" value="Submit" id="submitdata" class="btn btn-primary">
             ...
             <!-- / col-md-6 -->
                    <div class="col-md-6" id="taaaahhh" style="display: none;">
                        <div class="qr-code">
