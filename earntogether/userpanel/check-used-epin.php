...
if (isset($_POST['update'])) {
 ...
 if($_POST['t_password'] == $f['t_code'] )
      {
         header('location:used-epin.php');
         exit;
         
        }else{
            header('location:check-used-epin.php?msg=Wrong Transaction Password!');
            exit;
        }
...
<html lang="en">
           ...
           <form name="bankinfo" method="post">
              <section class="panel">
                ...
                <header class="panel-heading" style="color:#000;">
                  <h3 class="panel-title">TRANSACTION PASSWORD CONFIRMATION</h3>
                </header>
  ...
  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input name="t_password" type="password" tabindex="1" value=""  style="width:100%; border:1px solid #ebebeb; padding:5px;" class="form-control" id="exampleInputAddress" required />
 ...
 <?php include("rightside-panel.php");?>
  ...
  jQuery(document).ready(function() {
    ...
    (function() {
        ...
        HeatmapData.proif (isset($_POST['update'])) {
