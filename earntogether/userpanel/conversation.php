    ...
    <div class="animsition">  
      ...
      <main id="playground">
                    ...
                    <div class="col-md-4">
                      ...
                      <ul>
                        <li>
                          <a href="#">
                            <div class="img-container">
                              <img src="../demofiles/demoimage.gif" alt="">
                            </div>
                            <span>Jon Snow</span>
                          </a>
                        </li>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown language-nav">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#"><img src="../src/img/flags/Spain.png" data-no-retina  alt=""> Spanish</a></li>
                    <li><a href="#"><img src="../src/img/flags/France.png" data-no-retina  alt=""> French</a></li>
                    <li><a href="#"><img src="../src/img/flags/Germany.png" data-no-retina  alt=""> German</a></li>
                    <li><a href="#"><img src="../src/img/flags/Italy.png" data-no-retina  alt=""> Italian</a></li>
                  </ul>
                </li>
        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-8">
            <h1>Conversation</h1>
            <p class="lead">Conversation with <strong>Cersei Lannister</strong></p>
          </div>
            ...
            <div class="col-md-12">
              ...
              <ul class="chat-playground">
                ...
                <li class="primary">
                  ...
                  <p>Sed placerat nisl nec nibh pulvinar rutrum. Sed sodales purus...</p><br>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque ex ante, cursus sit amet ornare nec, pellentesque a arcu. Etiam pretium ligula sed erat tincidunt maximus. </p><br>
                ...
                <li class="primary">
                  ...
                  <p>Etiam pretium ligula sed erat tincidunt maximus. </p><br>
                  <div class="attachment">
                    <i class="ti-file"></i> sending <strong>somefile2.zip</strong>
                    <div class="progress progress-striped active no-margin margin-top-15">
