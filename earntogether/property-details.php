...
<!-- Title -->
<title>Investors Guru</title>
<!-- Favicon -->
<link href="images/favicon---new.png" sizes="128x128" rel="shortcut icon" type="image/x-icon" />
</head>
<body>
<div class="wrapper">
		...
		<div class="container-fluid p0">
		    ...
		    <nav>
		        ...
		        <div class="menu-toggle">
		            <img class="nav_logo_img img-fluid" src="images/Logo-1.png" alt="header-logo.png">
		        ...
		        <a href="#" class="navbar_brand float-left dn-smd">
		            <img class="logo1 img-fluid" src="images/Logo-1.png" alt="header-logo.png">
		            <img class="logo2 img-fluid" src="images/Logo-3 (2).png" alt="header-logo2.png">
		        </a>
		        ...
		        <ul id="respMenu" class="ace-responsive-menu text-left" data-menu-style="horizontal">
		           ...
		           <li>
		                ...
		                <ul>
		                    <li>
		                        <a href="property-page.php">Jaunpur</a>
		                        <ul>
				                    <li><a href="">Sirkoni</a>
				                    <ul>
		            ...
		            <li>
		                <a href="events.html"><span class="title">Events</span></a>
	                ...
	                <li class="list-inline-item list_s float-right">
	                	<a href="http://103.154.2.116/~investorsguruind/userpanel/login.php" class="btn flaticon-user"> <span class="dn-lg">Login</span></a>
	                </li>
					<li class="list-inline-item list_s float-right">
	                	<a href="http://103.154.2.116/~investorsguruind/userpanel/register.php" class="btn flaticon-user"> <span class="dn-lg">Register</span></a>
	                </li>
		        </ul>
		    </nav>
		</div>
	...
	<div id="page" class="stylehome1 h0">
		<div class="mobile-menu">
			<div class="header stylehome1">
				<div class="d-flex justify-content-between">
					...
					<a class="nav_logo_img" href="index.html"><img class="img-fluid" src="images/Logo-1.png" alt="header-logo2.png"></a>
					<a class="mobile-menu-reg-link" href="http://103.154.2.116/~investorsguruind/userpanel/register.php"><span class="flaticon-user"></span></a>
				</div>
			</div>
		</div><!-- /.mobile-menu -->
		<nav id="menu" class="stylehome1">
			<ul>
				...
				<li><a href="http://103.154.2.116/~investorsguruind/userpanel/login.php"><span class="flaticon-user"></span> Login</a></li>
				<li><a href="http://103.154.2.116/~investorsguruind/userpanel/register.php"><span class="flaticon-edit"></span> Register</a></li>
					...
					<div class="row m0">
						<div class="col-lg-12 p0">
							<div class="spls_style_one pr1 1px">
								<img class="img-fluid w100" src="images/property/ls1.jpg" alt="ls1.jpg">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row m0">
						<div class="col-sm-6 col-lg-6 p0">
							<div class="spls_style_one">
								<a class="popup-img" href="images/property/ls2.jpg"><img class="img-fluid w100" src="images/property/ls2.jpg" alt="ls2.jpg"></a>
							</div>
						</div>
						<div class="col-sm-6 col-lg-6 p0">
							<div class="spls_style_one">
								<a class="popup-img" href="images/property/ls3.jpg"><img class="img-fluid w100" src="images/property/ls3.jpg" alt="ls3.jpg"></a>
							</div>
						</div>
						<div class="col-sm-6 col-lg-6 p0">
							<div class="spls_style_one">
								<a class="popup-img" href="images/property/ls4.jpg"><img class="img-fluid w100" src="images/property/ls4.jpg" alt="ls4.jpg"></a>
							</div>
						</div>
						<div class="col-sm-6 col-lg-6 p0">
							<div class="spls_style_one">
								<a class="popup-img" href="images/property/ls5.jpg"><img class="img-fluid w100" src="images/property/ls5.jpg" alt="ls5.jpg"></a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="listing_single_description2 mt30-767 mb30-767">
								<div class="single_property_title">
									<h2>Agricultural/Farm Land </h2>
									<p>Sirkoni, Jaunpur Uttar Pradesh</p>
								</div>
						...
						<div class="col-lg-12">
							<div class="listing_single_description style2">
						    	...
						    	<p class="mb25">Agricultural/Farm Land availble for sale at Sirkoni, Jaunpur with 15 Biswa area in in 30 Lac INR/ affordable rate / for more please contact in given number.</p>
						...
						<div class="col-lg-12">
							<div class="application_statics mt30">
								<h4 class="mb30">Location <small class="float-right"> Kulhana, Mau, Sirkoni, Jaunpur Uttar Pradesh</small></h4>
...
<!-- Mirrored from creativelayers.net/themes/findhouse-html/page-listing-single-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2023 13:18:35 GMT -->
</html>