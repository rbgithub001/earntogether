          ...
          <div class="col-sm-12">
            ...
            <ul class="nav nav-tabs nav-justified">
              ...
              <div class="tab-content wht-box">
                ...
                <?php $product_show=mysqli_query($GLOBALS["___mysqli_ston"], "select * from products where status='0' and mode='Most Popular' order by product_id desc");
				      while($products=mysqli_fetch_array($product_show)){
                ...
                <div class="tab-pane fade" id="recommended">
                   <?php $product_show=mysqli_query($GLOBALS["___mysqli_ston"], "select * from products where status='0' and mode='Recommended' order by product_id desc");
				      while($products=mysqli_fetch_array($product_show)){
                ...
                <div class="tab-pane fade" id="recent">
                 <?php $product_show=mysqli_query($GLOBALS["___mysqli_ston"], "select * from products where status='0' and mode='Recent' order by product_id desc");
				      while($products=mysqli_fetch_array($product_show)){
                ...
                <div class="tab-pane fade" id="last">
                  <?php $product_show=mysqli_query($GLOBALS["___mysqli_ston"], "select * from products where status='0' and mode='Last Chance' order by product_id desc");
				      while($products=mysqli_fetch_array($product_show)){
