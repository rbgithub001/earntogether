 ...
 */
$GLOBALS['csrf']['input-name'] = '__csrf_token';
...
function csrf_callback($tokens) {
    ...
    echo "<html><head><title>CSRF check failed</title></head>
        <body>
        <p>Your form session may have expired, or you may not have
        cookies enabled.</p>
        <form method='post' action='index.php'>$data<input type='submit' value='Try again' /></form>
       </body></html>
";
}
