...
if($pagenmae!='regis100.php' && $pagenmae!='regis3.php' && $pagenmae!='regis2.php' && $pagenmae!='userfinder.php'){
...
define('DB_USERNAME','kamcal_mti');
define('DB_PASSWORD','Password@!@#$%');
define('DB_DATABASE','kamcal_mti');
define('SITE_URL','http://182.76.237.227/~kamcal/mti/');
define('EMAIL','info@mti.com');
define('TABLE_PREFIX','');
...
<?php
     ...
     $data = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $data);
   	return $data;
    }
