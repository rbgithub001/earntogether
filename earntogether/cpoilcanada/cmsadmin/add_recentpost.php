...
$str="insert into manage_recentpost set logo_title='".$title."',logo_desc='".$content."',logo_name='".$image."',date='".$time."'";
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Add Recent Post <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        
                       
                        <div class="panel-body">
                            <form class="form-horizontal" name="form-s" role="form" method="post" action="" enctype="multipart/form-data">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label"> Recent Post Title</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter New title" required value="" >
                                       
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload  Recent Post picture:</label>
                                    <div class="col-lg-10">
                                        <input name="file_name" type="file"  value="" class="form-control" placeholder=""   ></br>
