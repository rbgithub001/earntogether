...
<!--                                </span>-->
          ...
          <form name="myform" onSubmit="return ValidateData(this);" method="post"  action="approve-release-hold-commison.php">

                            <div class="table-responsive">
                                <div class="form-group">
                                    <div class="col-lg-offset-10 col-lg-2">
                                        <input name="Show" type="submit" class="btn btn-primary" id="Show" value="Approve and Release" onClick="setTimeout('window.location.reload()',3000);">
                                    </div>
                                </div>
                            <table class="table">
                             <thead>
                     ...
                     <?php
                      $i=1;
                      $total=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit_hold  order by id desc");
                    ...
                    <tr>
                        <th scope="row"><?php echo $i;?></th>
                         <td>
                                    <input type="checkbox" name="list[]" id="list[]" value="<?php echo $data1['id'] ?>">
                                </td>
                        <td><?php echo $data1['receive_date'];?></td>
                        <th>
                            <!--<a href="invoice_details.php?invoice_no<?php echo $data1['invoice_no'];?>" style="color:blue">-->
                      ...
                      <?php $i++;} ?>
                           ...
                           <td style="font-weight:bold;text-align:center;"><h4>Total Payble Commission Amount= <?php echo CURRENCY.' '. number_format($total,2); ?></h4></td>
