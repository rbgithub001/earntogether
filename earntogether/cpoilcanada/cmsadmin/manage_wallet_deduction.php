...
mysqli_query($GLOBALS["___mysqli_ston"], "update wallet_charges set w_charge='$charge' where id=1");

header("location:manage_wallet_deduction.php?msg=Updated Successfully !");
}
    ...
    <?php include("top-menu.php");?>
            ...
            <div class="row">
                <div class="col-lg-7 center-block" style="float:none;">
                    ...
                    <?php $date1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from wallet_charges where id=1 "));  ?>

                        <header class="panel-heading">
                        Manage wallet deduction Charges <span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                         
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">wallet Charges(%)</label>
                                    <div class="col-lg-10">
