...
$id=$_GET['id'];
$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from property_size_price where id='".$id."'");
...
$str="update property_size_price set size='".$property_size."', price='".$property_price."' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

// $str="insert into property_size_price (size,price) values('$property_size','$property_price')";
// $res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:manage-size-price-property.php?msg=Property Information Updated Successfully !");
}
else{
    header("location:edit_property_size_price.php?msg1=Something Went Wrong !");
}
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Property Size</label>
                                    <div class="col-lg-10">
                                       <input required type="text" name="property_size" class="form-control" placeholder="Property Size" value="<?php echo $row['size'] ?>">
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Property Price</label>
                                    <div class="col-lg-10">
                                       <input required type="text" name="property_price" class="form-control" placeholder="Property Price" value="<?php echo $row['price'] ?>">
                                    </div>
                                </div>
