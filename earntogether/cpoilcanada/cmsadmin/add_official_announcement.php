...
$str="insert into promo set news_name='".$content."',description='".$description."',status='".$status."',posted_date='".$date."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:official-announcement.php?msg=Official announcement Inserted Successfully !");
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="content" class="form-control" placeholder="Enter title" required value="" >
