                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                                  Downline Member Package Report
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from lifejacket_subscription where remark='Downline Package Upgrade' $qry");
                            ...
                            <tr style="text-align:center;">
                                <td>
                                  ...
                                  <td>
                                    <?php echo $data1['sponsor'];?> /  <?php 
                                   $data112=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select username,first_name,last_name from user_registration where user_id='".$data1['sponsor']."'"));
                                    echo $data112['username'];?>
                                </td>

                                <td>
                                    <?php echo $data1['user_id'];?> /  <?php 
                                   $data11=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select username,first_name,last_name from user_registration where user_id='".$data1['user_id']."'"));
