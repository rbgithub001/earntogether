...
if(isset($_POST['Add']))
{
  ...
  mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set fund_status='$bstatus' where user_id='".$_POST['userid']."'");
   

   header("location:fundwith_blocker.php?msg= Fund withdrawal Blocked Status Updated Successfully..!");
  exit;
  }
  else{
     header("location:fundwith_blocker.php?msg=Userid and username not match");
  exit;
  }
}
?><!DOCTYPE html>
