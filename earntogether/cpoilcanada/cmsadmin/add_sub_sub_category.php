...
$str="insert into sub_sub_categories set name='".$name."', sub_category_id='$product2', date='".date('Y-m-d')."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:add_sub_sub_category.php?msg=New Category Added Successfully!");
}}
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Product Sub Category</label>
                                    <div class="col-lg-10">
                                             <select name="product2" class="form-control">
                                    <?php $action=mysqli_query($GLOBALS["___mysqli_ston"], "select * from sub_categories where status=0");
                                        while($data=mysqli_fetch_array($action)) {
                                       ?>
                                       <option value="<?php echo $data['sub_category_id'];?>"><?php echo $data['name'];?></option>
                                       <?php } ?>
                                       </select>
                             ...
                             <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sub Sub Category Name</label>
                                    <div class="col-lg-10">
