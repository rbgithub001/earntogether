...
$pstatus=$_REQUEST['pstatus']; 
 ...
 // $array=array();
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  credit_amt LIKE '$comsn%' ";  
  }
   if($mname!='')
  {
  ...
  // echo "<br>";exit;
    $selectquery=mysqli_query($GLOBALS["___mysqli_ston"], "select user_id from user_registration where binary_pos='".$pstatus."'");

    while ($rew=mysqli_fetch_array($selectquery)) {
    $array=$rew['user_id'];  

        $query1233[]="select * from credit_debit where ttype='Fund Transfer'  and  user_id='".$rew['user_id']."'";  
    }
//    print_r($array);
  //  exit;
...
<div class="col-sm-2">
<input name="comsn" value="" type="text" placeholder="amount" class="form-control">
</div>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  ...
                                  if($qry2!='')
                                  {
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], $qry2);
                                 
                                  }
                                  else
                                  {
                                    
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where (Cause='Fund Credited By Admin' || Cause='Fund Debited By Admin') $qry order by id desc");
                                  }
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    ...
                                    $user=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['user_id']."'")); 
                                ...
                                <td>
                                 ...
                                 <td>
                                     <?php echo number_format($data1['debit_amt'],2);?>
                                </td>
                                <td>
                                  <?php echo $data1['Cause'];?>
                                </td>
                      ...
                      <td></td>
                      <td></td>
                      <td style="font-weight:bold;text-align:center;"><h4>Total Team Bonus = </h4></td>
