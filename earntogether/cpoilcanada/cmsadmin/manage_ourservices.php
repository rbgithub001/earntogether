            ...
            <div class="wrapper">
             <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="add_ourservices.php" class="btn btn-success">ADD RECENT PROJECT</a>
                    ...
                    <div class="col-sm-12">
                        <section class="panel"><span style="aligh:centre;color:red;"><h4><?php echo @$_GET['msg1'];?></h4></span>
                            ...
                            //echo "select * from manage_logo where id='1'" ;exit();
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_ourservices ");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $project11=  substr($data1['logo_desc'],0,500);?>
                                </td>
             ...
             <span style="margin-left:5px;"><a href="update_ourservices.php?pid=<?php echo $data1['id'];?>"><img src="images/edit.png" /></a></span>
            
            <span style="margin-left:5px;"><a href="delete_ourservices.php?id=<?php echo $data1['id'];?>" title="delete"><img src="images/Trashcan.png" style="height: 32px; width:32px;"  /></a></span>
                  </td>
