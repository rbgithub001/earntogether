            ...
            <div class="wrapper">
             ...
             <div class="row">
               ...
               <!-- <div class="col-sm-12 text-right">
                        ...
                        <a href="export_idproof_list.php" class="btn btn-success">export in excel</a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php 
$i=1;
$data=mysqli_query($GLOBALS["___mysqli_ston"],"select * from id_proof_list where status=1 order by id desc");
...
$dataq1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"],"select * from user_registration where user_id='".$data1['user_id']."'"));
 ?>
                            <tr style="text-align:center;">
                               ...
                               <td>
                                    <?php echo $data1['id_proof'];?>
                                </td>
                                
                                <td>
                                    <?php echo $data1['id_number'];?>
                                </td>
                                   
                                 <td>
                                   <a href="../userpanel/<?php echo $data1['id_image'];?>" target="_blank">View Front Side</a><br>
