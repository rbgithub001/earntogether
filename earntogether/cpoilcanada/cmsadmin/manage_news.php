    ...
    <section>
        ...
        <div class="body-content" >
            ...
            <div class="wrapper">
                    ...
                    <div class="col-sm-12">
                        <section class="panel"><span style="aligh:centre;color:red;"><h4><?php echo @$_GET['msg1'];?></h4></span>
                            ...
                            //echo "select * from manage_logo where id='1'" ;exit();
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_news ");
             ...
             <span style="margin-left:5px;"><a href="update_news.php?pid=<?php echo $data1['id'];?>" title="Edit/update"><img src="images/edit.png" /></a></span>
            
            <span style="margin-left:5px;"><a href="delete_news.php?id=<?php echo $data1['id'];?>" title="Delete"><img src="images/Trashcan.png" style="height: 32px; width:32px;"  /></a></span>
                  </td>
