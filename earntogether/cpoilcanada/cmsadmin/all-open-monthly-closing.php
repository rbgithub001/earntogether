                              ...
                              //{
                                 ...
                                 // echo "select user_id from amount_detail where purchase_date between '$startdate' and '$enddate' group by user_id having sum(total_invoice_cv) >= 1000";
                                  ...
                                  while($data1=mysqli_fetch_array($data)){
                                        ...
                                        $leveltot = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='0' and ttype='Level Income'"));
                                        ...
                                        $crddbt = mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(credit_amt) as crdamt from credit_debit where user_id='$uid' and status='0' and ttype=('Level Income' || 'Co-founder Income')"));
