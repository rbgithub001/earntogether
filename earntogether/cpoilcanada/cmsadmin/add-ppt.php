...
$str="insert into ppt set logo_title='".$title."',logo_desc='".$content."',logo_name='".$image."',date='".$date."'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
//$msg="New NEWS Uploaded";
header("location:manage_ppt.php?id=". $id."&msg=Power Point Slider Uploaded Successfully !");
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        Upload Power Point Slider<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="title" class="form-control" placeholder="Enter Title" required value="" >
                                       
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Upload Power Point Slider:</label>
                                    <div class="col-lg-10">
                                        <input name="file_name" type="file"  value="" class="form-control" ></br>
