                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            <header class="panel-heading ">
                              Pending Proof List <span style="float:right;color:green;"><?php echo @$_GET['msg'];?></span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" style="background-color: #e51400;color: #fff;">Close</button>
                                  ...
                                  <td>
                                 <a href="activenow.php?id=<?php echo $dd['id'];?>&user=<?php echo $dd['user_id'];?>" class='btn btn-default' style="background-color: #e51400;color: #fff;" onclick="return confirm('Are you sure ?');">Activate Now</a>
                                </td>
