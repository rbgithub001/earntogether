                ...
                ?>
                            ...
                            <?php 
                                ...
                                //   echo "select * from user_registration $qry";
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_rank_name='Free Member' and email='baba1008atm@gmail.com' order by id desc");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                 ...
                                 <td>
                                   <form method="post" action="memberactive1.php">
