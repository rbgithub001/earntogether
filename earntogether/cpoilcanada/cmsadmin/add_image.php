...
if(isset($_POST['Add']))
{
  ...
  $inser=mysqli_query($GLOBALS["___mysqli_ston"], "insert into images  values('','$title','$description','$name12','$upload_date')");
  if($inser)
  {
                ...
                <div class="col-lg-7 center-block" style="float:none;">
                    <section class="panel">
                        <header class="panel-heading">
                            Upload Banners<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <textarea rows="10" cols="60" name="des" placeholder="Enter Image Description.."></textarea>
                                       
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">Upload Image</label>
                                    <div class="col-lg-8">
