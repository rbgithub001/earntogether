...
if(isset($_POST['Add']))
{
  $head10=$_FILES['uploadedfile']['name'];
    ...
    mysqli_query($GLOBALS["___mysqli_ston"], "update admin set image='$filename12' where id=1");
    header("location:change-profile-photo.php?msg=Image Change Successfully!");
    }
    else
    {
     header("location:change-profile-photo.php?msg=Please upload a image!");
    }
}
                ...
                <div class="col-lg-7 center-block" style="float:none;">
                    <section class="panel">
                        <header class="panel-heading">
                            Total Direct Member Tree<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="user_id" name="user_id" placeholder="User ID/User name" class="form-control" required >
