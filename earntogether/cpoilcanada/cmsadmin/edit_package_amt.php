...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from package where id='".$id."'");
...
$str="update package set name='".$name."', max='".$max."', min='$min' WHERE id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:edit_package_amt.php?id=". $id."&msg=Package Updated Successfully !");
}}
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="name" class="form-control" placeholder="Enter Package Name" required value="<?php echo $row['name'];?>" >
                                       
                                    </div>
                                </div>
                                 <!-- <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sponsor Bonus</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="sponsor" class="form-control" placeholder="Enter Sponsor Commission" required value="<?php echo $row['sponsor_commission'];?>" >
                                       
                                    </div>
                                </div> -->
                               
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Min-Amount</label>
                                    <div class="col-lg-10">
                                        <input type="number" name="min" class="form-control" placeholder="Enter min" required value="<?php echo $row['min'];?>" >
                                                                 ...
                                                                 <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Max-amount</label>
                                    <div class="col-lg-10">
                                        <input type="number" name="max" class="form-control" placeholder="Enter max" required value="<?php echo $row['max'];?>" >
