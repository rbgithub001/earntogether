...
$pstatus=$_REQUEST['pstatus']; 
  ...
  $query123[]=" and  user_id='$username'";  
    ...
    if($comsn!='')
  {
  $query123[]="  and  credit_amt LIKE '$comsn%' and	ttype='Level Income'";  
  }
   if($mname!='')
  {
    ...
    <div class="total_invoice"  id="printArea">
                    ...
                    <thead>
                      ...
                      <th>User Name</th>
                         ...
                         <th>Purchased Amount (SAR)</th>
                        <th>Percentage(%)</th>
                        <th>Amount (SAR)</th><!-- Commission -->
                        <th>Remark</th>
                        <th>Purchased Invoice</th>
                        <th>Date</th>
                        <th>Status</th>
                      </tr>
                    </thead>
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $total=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where  ttype='Co-founder Income' and status=0 order by id desc");
                      while($data1=mysqli_fetch_array($data))
                      {
                        $total=$total+$data1['credit_amt'];
                        $userdata=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select user_id,first_name,last_name from user_registration where user_id='".$data1['user_id']."'"));
                    ...
                    <tr>
                        ...
                        <td><?php echo number_format($data1['Remark'],2);?></td>
