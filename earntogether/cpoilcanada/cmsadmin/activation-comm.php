...
$str="update commission_settings set active_amount='$active_amount' WHERE id=1";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");


header("location:activation-comm.php?id=". $id."&msg=Information Updated Successfully !");
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Active Qualification Amount<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
