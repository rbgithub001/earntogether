...
$str="insert into sub_categories set name='".$name."', date='".date('Y-m-d')."', status='0', category_id='$product1'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:add_sub_category.php?msg=New Category Added Successfully !");
}}
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                           Sub Categories Manage<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                                    ...
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sub Category Name</label>
                                    <div class="col-lg-10">
                                  ...
                                  <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Sub Category Name</label>
                                    <div class="col-lg-10">
                                        <input type="text" name="name" class="form-control" placeholder="Enter Category Name" required value="" >
