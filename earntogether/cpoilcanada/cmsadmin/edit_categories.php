...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysqli_query($GLOBALS["___mysqli_ston"], "select * from categories where category_id='".$id."'");
...
$str="update categories set name='".$name."',link='".$link."' WHERE category_id='$id'";
$res=mysqli_query($GLOBALS["___mysqli_ston"], $str)or die("error");

if($res)
{
header("location:edit_categories.php?id=". $id."&msg=Category Information Updated Successfully !");
}}
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Categories Manage<span style="float:right;color:red;"><?php echo @$_GET['msg'];?></span>
                        </header>
