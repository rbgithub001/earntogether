...
<div class="row">
<div class="col-md-12" style="border: 1px solid #DFDFDF; box-shadow: none; border-radius: 0px; color: #999; opacity: 1; padding: 22px 10px 10px 10px !important;">    
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $total=0;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from lifejacket_subscription where pay_type!='Bitcoin Payment' and pay_type!='Admin Activation' $qry order by id desc");
                                  while($data1=mysqli_fetch_array($data))
                                    { 
                            ...
                            <tr style="text-align:center;">
                               ...
                               <td>
                                ...
                                <td>
                                    <?php echo number_format($data1['amount'],2);?>
                                </td>
                                <!--<td>
                                    <?php // echo "Investment Wallet";?>
                                </td>
                           -->
                                 <td>
                                    <?php echo $data1['date'];?>
                      ...
                      <td></td>
                      <?php
                        $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(amount) as totalAmount from lifejacket_subscription where pay_type!='Bitcoin Payment' and pay_type!='Admin Activation' $qry order by id desc")); 
                      ?>
                      <td style="font-weight:bold;text-align:center;"><h4>Total Commission = </h4></td>
                      <td><span><h4><?php echo number_format($data['totalAmount'],2); ?></h4></span></td>
                      </tr>
