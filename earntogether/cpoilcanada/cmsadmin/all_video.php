            ...
            <div class="wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-right">
                        ...
                        <a href="upload_video.php" class="btn btn-success">Add New Video</a>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from video ");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $desc=substr($data1['description'],0,25);?>
                                </td>
                                
                                <td>
                                     <iframe width="150px" height="100px" src="<?php echo $data1['video_link'];?>" frameborder="0" allowfullscreen></iframe>
                                </td>
                                <td>
                                     <?php echo $data1['video_link'];?>
                                </td>
                               
                                <td>
                                     <?php echo $data1['upload_date'];?>
                                </td>
                                
                                <td>
                                     <a href="edit_video.php?edit=<?php echo $data1['id']?>">Edit</a>
                                </td>
                                <td>
                                     <a href="video_delete.php?del=<?php echo $data1['id']?>" onclick="return confirm('Are You Sure,Delete This Video Permanantly')">Delete</a>
                                </td>
                            </tr>
                            <?php $i++;} ?>
