        ...
        <div class="body-content" >
            ...
            <div class="row">
                  ...
                  <!--   <div class="col-sm-12 text-right">
                        ...
                        <a href="export_member_package_report.php" class="btn btn-success">Export in excel</a>
...
<input type="submit" name="submits" value="Submit" class="btn btn-success">           
    ...
    <div class="total_invoice"  id="printArea">
      ...
      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from lifejacket_subscription $query123 order by id desc ");
                      while($data1=mysqli_fetch_array($data))
                      {
        //$infouser=mysql_fetch_array(mysql_query("select * from user_registration where user_id='$data1[user_id]'"));
                            ...
                            <tr style="text-align:center;">
                               ...
                               <td><a href="invoice_details123?id=<?php echo $data1['id'];?>"><?php echo $data1['transaction_no'];?></a></td>

                                <!-- <td><?php echo $data1['lifejacket_id'];?></td> -->
                                    
                                 <td><?php echo $data1['date'];?></td>
                             <!--  <td><?php echo number_format($data1['amount'],2);?></td> -->
                        
                        <td><?php

 $package123=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from status_maintenance where id='$data1[package]'"));

 echo $package123['name'];?></td>

                          <td><?php echo $data1['remark'];?></td>
                          <td><?php echo $data1['pay_type'];?>
                                </td>

                        <td><a href="invoice_details123.php?id=<?php echo $data1['id'];?>">View Invoice</a></td>
                                <!--  <td>
                                    <?php echo $user['expire_date'];?>
                                </td> -->
