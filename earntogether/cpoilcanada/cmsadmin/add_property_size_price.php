...
if($res)
{
header("location:manage-size-price-property.php?msg=Property Information Added Successfully !");
}
                            ...
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                             <!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                       <input required type="text" name="property_size" class="form-control" placeholder="Property Size">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                       <input required type="text" name="property_price" class="form-control" placeholder="Property Price">
                                    </div>
                                </div>
