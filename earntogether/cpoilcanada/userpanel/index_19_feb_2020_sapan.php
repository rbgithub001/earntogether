...
// $left_jan   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-01-01')."' AND l_date<='".date('Y-01-31')."' "));
// $left_feb   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-02-01')."' AND l_date<='".date('Y-02-31')."' "));
// $left_march = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-03-01')."' AND l_date<='".date('Y-03-31')."' "));
// $left_April = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-04-01')."' AND l_date<='".date('Y-04-31')."' "));
// $left_may   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-05-01')."' AND l_date<='".date('Y-05-31')."' "));
// $left_june  = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-06-01')."' AND l_date<='".date('Y-06-31')."' "));
// $left_july  = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-07-01')."' AND l_date<='".date('Y-07-31')."' "));
// $left_aug   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-08-01')."' AND l_date<='".date('Y-08-31')."'  "));
// $left_sep   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-09-01')."' AND l_date<='".date('Y-09-31')."'  "));
// $left_oct   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-10-01')."' AND l_date<='".date('Y-10-31')."'  "));
// $left_nov   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-11-01')."' AND l_date<='".date('Y-11-31')."'  "));
// $left_dec   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-12-01')."' AND l_date<='".date('Y-12-31')."'  "));

// $right_jan   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-01-01')."' AND l_date<='".date('Y-01-31')."' "));
// $right_feb   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-02-01')."' AND l_date<='".date('Y-02-31')."' "));
// $right_march = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-03-01')."' AND l_date<='".date('Y-03-31')."' "));
// $right_April = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-04-01')."' AND l_date<='".date('Y-04-31')."' "));
// $right_may   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-05-01')."' AND l_date<='".date('Y-05-31')."' "));
// $right_june  = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-06-01')."' AND l_date<='".date('Y-06-31')."' "));
// $right_july  = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-07-01')."' AND l_date<='".date('Y-07-31')."' "));
// $right_aug   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-08-01')."' AND l_date<='".date('Y-08-31')."'  "));
// $right_sep   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-09-01')."' AND l_date<='".date('Y-09-31')."'  "));
// $right_oct   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-10-01')."' AND l_date<='".date('Y-10-31')."'  "));
// $right_nov   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-11-01')."' AND l_date<='".date('Y-11-31')."'  "));
// $right_dec   = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select income_id from matrix_downline where income_id='".$f['user_id']."' AND l_date>='".date('Y-12-01')."' AND l_date<='".date('Y-12-31')."'  "));
...
$total_downline_left=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from matrix_downline where income_id='$userid' and leg='left'"));
$total_downline_right=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from matrix_downline where income_id='$userid' and leg='right'"));
...
$b_wallet=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select amount from b_wallet where user_id='$userid'"));
$b_wallet_amount=$b_wallet['amount'];

$t_wallet=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select amount from t_wallet where user_id='$userid'"));
$t_wallet_amount=$t_wallet['amount'];


$rmb_wallet=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select amount from rmb_wallet where user_id='$userid'"));
$rmb_wallet_amount=$rmb_wallet['amount'];
?>
...
$left_investments = $left_investment['left_invest'];
    ...
    if($left_investments>=5000 && $f['rank']=='0')
          {
      
            mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set rank='1', designation='Executive' where user_id='$userid'");
            mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `rank_achiever` (`id`, `user_id`, `last_rank`, `move_rank`, `ts`, `qualify_date`) VALUES (NULL, '$userid', 'Executive', 'Samsung Phone', CURRENT_TIMESTAMP, '$date')");

            
          }


          if($left_investments>=10000 && $f['rank']=='1')
          {
            mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set rank='2', designation='Senior Executive' where user_id='$userid'");
            mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `rank_achiever` (`id`, `user_id`, `last_rank`, `move_rank`, `ts`, `qualify_date`) VALUES (NULL, '$userid', 'Senior Executive', 'Samsung Phone', CURRENT_TIMESTAMP, '$date')");

            
          }

           if($left_investments>=15000 && $f['rank']=='2')
          {
            mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set rank='3', designation='Manager' where user_id='$userid'");
            mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `rank_achiever` (`id`, `user_id`, `last_rank`, `move_rank`, `ts`, `qualify_date`) VALUES (NULL, '$userid', 'Manager', 'Samsung Phone', CURRENT_TIMESTAMP, '$date')");

            
          }


          if($left_investments>=20000 && $f['rank']=='3')
          {
            mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set rank='4', designation='Senior Manager' where user_id='$userid'");
            mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO `rank_achiever` (`id`, `user_id`, `last_rank`, `move_rank`, `ts`, `qualify_date`) VALUES (NULL, '$userid', 'Senior Manager', 'Samsung Phone', CURRENT_TIMESTAMP, '$date')");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(amount) as amount from lifejacket_subscription where user_id='$userid' "));
$working_e_wallet=$working_e_wallet1['amount'];

$roi_e_wallet=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from final_e_wallet where user_id='$userid' "));
...
?>
  ...
  "locale": "en"
                                        ...
                                        <div class="col-md-12 col-sm-12" id="example2">
                                            ...
                                            <h2 class="dashboard" style="padding-top:20px;"> ( MY ID : <?php echo $f['user_id'];?>/<?php echo strtoupper($f['username']);?>/ Rank : <?php echo $f['designation'];  ?> )</h2>
                                            </div>
                                           ...
                                           <div class="col-md-6 col-sm-6">
											...
											<div class="row"
                                            <div class="col-md-7">
                                            <h2 style="color:#fff;font-size: 16px;font-weight: bold;">Account Status : Inactive Member </h2>
                                            </div>
                                            ...
                                            <div class="col-md-12 text-right">
                                                <h2 style="color:#fff;font-size: 16px;font-weight: bold;">My Package :                                    <?php


    $total_earnssing11=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(amount)as ssss from lifejacket_subscription where user_id='$userid' and pb>'0' order by id desc limit 0,1"));                        
    

// if ($total_earnssing11>=100 && $total_earnssing11>=249) { 
//   mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set user_plan='1'  where user_id='$userid'"); 
// }else if ($total_earnssing11>=250 && $total_earnssing11>=1999) { 
//   mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set user_plan='2'  where user_id='$userid'"); 
// }else if ($total_earnssing11>=2000 && $total_earnssing11>=4999) { 
//   mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set user_plan='3'  where user_id='$userid'"); 
// }else if ($total_earnssing11>=5000) { 
//   mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set user_plan='4'  where user_id='$userid'"); 
// }else{
//   echo "Free User";
// }
...
if ($f['user_plan']=='1') { ?>
<b>Plan-1</b>
<!--<img src="images/bronze.png" alt="" style='width: 55px;'/>-->
<?php }else if ($f['user_plan']=='2') { ?>
<!--<img src="images/silver.png" alt="" alt="" style='width: 55px;'/>-->
<b>Plan-2</b>

<?php }else if ($f['user_plan']=='3') { ?>
<b>Plan-3</b>

<!--<img src="images/gold.png" alt="" alt="" style='width: 55px;'/>-->
<?php }else if ($f['user_plan']=='4') { ?>
<!-- <img src="images/diamond.png" alt="" alt="" style='width: 55px;'/>  -->
<b>Plan-4</b>

<?php }else{
   echo "Silver consultant";
}
									...
									<!--	<p><strong>Merry XMAS</strong> : Enjoy xmas with us. free 10 $ bonus to paid members.</p>-->
									<!--	</marquee>-->
									<!--</div>-->
                                     ...
                                     <div class="row">
                                            ...
                                            <!--        </div>-->
                                            <!--        <div class="card-content">-->
                                            <!--            <p class="category"><strong>Royalty Income</strong></p>-->
                                            <!--            <h3 class="card-title">$ <?php //echo number_format($direct_incomes,2); ?></h3>-->
                                            <!--        </div>-->
                                            <!--        <div class="card-footer">-->
                                            <!--            <div class="stats">-->
                                            <!--                <i class="material-icons text-info">info</i>-->
                                            <!--                <a href="retail-income.php">See detailed report</a>-->
                                            <!--            </div>-->
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <!--</div>-->
                                            ...
                                            <!--        </div>-->
                                            <!--        <div class="card-content">-->
                                            <!--            <p class="category"><strong>Referral bonus</strong></p>-->
                                            <!--            <h3 class="card-title">$ <?php echo number_format($direct_incomes,2); ?></h3>-->
                                            <!--        </div>-->
                                            <!--        <div class="card-footer">-->
                                            <!--            <div class="stats">-->
                                            ...
                                            <!--        </div>-->
                                            <!--        <div class="card-content">-->
                                            <!--            <p class="category"><strong>RMB bonus</strong></p>-->
                                            <!--            <h3 class="card-title">$ <?php echo number_format($rmb_earning['total7'],2); ?></h3>-->
                                            <!--        </div>-->
                                            <!--        <div class="card-footer">-->
                                            <!--            <div class="stats">-->
                                            <!--                <i class="material-icons text-info">info</i>-->
                                            ...
                                            <!--        </div>-->
                                            <!--        <div class="card-content">-->
                                            <!--            <p class="category"><strong>RESIDUAL INCOME</strong></p>-->
                                            <!--            <h3 class="card-title">$ <?php echo number_format($residual_earning['total8'],2); ?></h3>-->
                                            <!--        </div>-->
                                            <!--        <div class="card-footer">-->
                                            <!--            <div class="stats">-->
                                            <!--                <i class="material-icons text-info">info</i>-->
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 120px;">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="category"><strong>T Wallet</strong></p>
                                                        <h3 class="card-title">$ <?php echo number_format($t_wallet_amount,2); ?></h3>
                                              ...
                                              <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 120px;">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="category"><strong>B Wallet</strong></p>
                                                        <h3 class="card-title">$ <?php echo number_format($b_wallet_amount,2); ?></h3>
                                              ...
                                              <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 120px;">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="category"><strong>RMB Wallet</strong></p>
                                                        <h3 class="card-title">$ <?php echo number_format($rmb_wallet_amount,2); ?></h3>
                                           ...
                                           <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 120px;">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="category"><strong>TITO Wallet</strong></p>
                                            ...
                                            <!--            </div>-->
                                            <!--            <div class="card-content">-->
                                            <!--                <p class="category"><strong>Income Wallet Balance</strong></p>-->
                                          ...
                                          <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 120px;">
                                                    ...
                                                    <div class="card-content"><!-- Investments -->
                                                        ...
                                                        <h3 class="card-title">$ <?php echo number_format($working_e_wallet,2); ?></h3>
                                                    </div>
                                        ...
                                        <!--                    <h4 class="card-title">$ <?php //echo number_format($left_investments); ?>  </h4>-->
                                        <!--                                    </div>-->
   ...
   <!--             </div>-->
                    ...
                    <!--        <div class="col-md-12">-->
                    <!--          <h3> Joining Link</h3>-->
                    <!--          <p ><a href="http://182.76.237.238/~syscheck/ttto/userpanel/register.php?referral=<?php echo $f['username'];?>" style="color: #fff;">TTTO.com</a></p>-->
                             
                             <!--<button onclick="myFunction()">Copy</button>-->
                    <!--          <div class="social-medi-icons padder-md">-->
                    <!--            <a target="_blank" href="http://www.facebook.com/sharer.php?u=http://182.76.237.238/~syscheck/ttto/register.php?referral=<?php echo $f['username'];?>&pos=left">-->
                    <!--              <img class="img-circle img-responsive" src="images/facebook.png" alt="">-->
                    <!--            </a>-->
                    <!--            <a target="_blank" href="http://twitter.com/share?url=http://182.76.237.238/~syscheck/ttto/register.php?referral=<?php echo $f['username'];?>&pos=left">-->
                    <!--              <img class="img-circle img-responsive" src="images/twitter.png" alt="">-->
                    <!--            </a>-->
                    <!--            <a target="_blank" href="https://api.whatsapp.com/send?text=http://182.76.237.238/~syscheck/ttto/register.php?referral=<?php echo $f['username'];?>&pos=left">-->
                    <!--              <img class="img-circle img-responsive" src="images/whatsapp2.png" alt="">-->
                    <!--            </a>-->
                    <!--            <a target="_blank" href="https://plusone.google.com/_/+1/confirm?hl=en&url=http://182.76.237.238/~syscheck/ttto/register.php?referral=<?php echo $f['username'];?>&pos=left">-->
