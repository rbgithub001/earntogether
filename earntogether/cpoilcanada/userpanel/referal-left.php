          ...
          <div class="row">
           ...
           <form name="bankinfo" method="post">
					...
					<div class="panel panel-primary">
						...
						<h4 class="m-t-none text-center text-primary-lt font-thin-bold font-semi-bold">REFERRAL LINK FOR LEFT POSITION</h4>
						...
						<div class="text-center">
							...
							<a href="http://182.76.237.227/~syscheck/farex/userpanel/register.php?referral=<?php echo $f['username'];?>&pos=left" rel="gallery" target="_blank" <?php $i=1;?> id="myInput<?= $i?>">
						  http://182.76.237.227/~syscheck/farex/userpanel/register.php?referral=<?php echo $f['username'];?>&pos=left
