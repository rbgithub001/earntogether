...
header("location:update-beneficiary.php?url=$url&msg= Updated Successfully !");
}
...
<html lang="en">
 ...
 <p><div align="center" style="color:lightgreen;font-weight:bold;float: right;"><?php echo @$_GET['msg'];?></div></p>
        <!-- PAGE TITLE -->
        <!--<section id="example2">
          <div class="row">
          <div class="col-md-8">
			...
			<div class="panel panel-primary">
				<div class="panel-body">
				    <?php if($f['ben_acc_no']!="" and $f['ben_bank']!=""){ ?>
				     <span style="font-size:20px;color:lightgreen;"><b>Contact admin to update your beneficiary </b></span>
				     <?php } ?>
