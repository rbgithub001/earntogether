...
function Display_username($ref)
{
  $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select username from user_registration where user_id='$ref'"));
  $xc=$data['username'];
  return $xc;
...
function Display_user_status($ref)
{
  $data=mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select id from user_registration where user_id='$ref' and user_rank_name='Paid Member'"));
  if($data>0)
  {
  return "Active";
  }
...
?>      
        <div class="col-md-12">
              <div class="table-responsive">
				<div class="col-md-3">
			<form name="tree" method="post" action="binary-tree.php">
	<input type="text" name="id" style="width:150px;" value="" paceholder="Enter Userid / username">&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" name="submit" value="Search">&nbsp;&nbsp;&nbsp;&nbsp;<?php if($_GET['id']!='') { ?> <a href="binary-tree.php"> <input type="button" value="Back" name="backs"> </a> <?php } ?>
</form><br />
				</div>
...
?>    
    ...
    <?php if($fz['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($fz['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($fz['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?>
                            ...
                            <br />
 <?php echo $fz['username'];?> <br/> <?php echo date('d-m-Y',strtotime($fz['registration_date']));?>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      ...
                                      <td align="left"><?php echo Display_username($fz['ref_id']);?></td>
                                    </tr>
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$fz['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$fz['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr> -->

                                   <tr>
                                      <td align="left">Total Investment</td>
                                      <td align="left"> <?php
                                      $leftamt1=0;
...
$working_e_wallet2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
 $working_e_wallet2['amount'];
  $rightamt1=$rightamt1+$working_e_wallet2['amount'];
                                 ...
                                 ?>L: <?php  echo $leftamt1; ?> | R: <?php  echo $rightamt1; ?></td>
                                    </tr>
                                   <!--   <tr>
                                      <td align="left">Today Business:</td>
...
?>
               <ul>
                  <li>
                    <a  <?php if($userid !='' && $user1['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user1['user_id'];?>" <?php } ?> class="tooltip1"> <?php if($user1['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user1['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user1['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?><br /><?php if($user1['user_id']!='') { ?>
                                  <?=$user1['username']?> <br/> <?php echo date('d-m-Y',strtotime($user1['registration_date']));?>
                    ...
                    <span>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user1['ref_id']); ?></td>
                                    </tr>
                                   
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user1['user_id']);?></td>
                                    </tr>
   ...
   <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user1['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user1['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user1['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user1['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                      ...
                      <ul>
                        ...
                        <li>
                          <a  <?php if($info1 !='' && $user2['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user2['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user2['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user2['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user2['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?><br /><?php if($user2['user_id']!='') { ?>
                                        <?=$user2['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user2['registration_date']));?>
                           ...
                           <?php if($user2['user_id']!=''){?><span>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user2['ref_id']); ?></td>
                                    </tr>

                                  
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user2['user_id']);?></td>
                                    </tr>
   ...
   <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user2['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user2['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!-- <tr>
 ...
 <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user2['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user2['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr> -->
                           ...
                           <a <?php if($info2 !='' && $user3['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user3['user_id']?>" <?php } ?> class="tooltip1">   <?php if($user3['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon" /><?php }else if($user3['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon" /><?php }  else if($user3['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon" /><?php }  else{?><img src="images/empty.gif" class="iicon" /><br/><?php } ?><?php if($user3['user_id']!='') { ?>
                             <br/><?=$user3['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user3['registration_date']));?>
                               ...
                               <?php if($user3['user_id']!=''){?> <span>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user3['ref_id']); ?></td>
                                    </tr>

                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user3['user_id']);?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user3['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user3['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user3['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user3['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                                ...
                                <li>
                                  <a <?php if($info2 !='' && $user4['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user4['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user4['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($user4['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user4['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png"  class="iicon"/><?php }else if($user4['user_rank_name']=="Director"){?><img src="images/director.png"  class="iicon"/><?php }  else if($user4['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif"  class="iicon"/><br/><?php } ?><?php if($user4['user_id']!='') { ?>
                                   <br/><?=$user4['username']?> <br/> <?php echo date('d-m-Y',strtotime($user4['registration_date']));?>
                                 ...
                                 <?php if($user4['user_id']!=''){?> 
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user4['ref_id']); ?></td>
                                    </tr>

                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user4['user_id']);?></td>
                                    </tr>
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user4['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user4['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user4['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user4['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
  ...
  $rightamt1=$rightamt1+$working_e_wallet2['amount'];
                          ...
                          <li>
                           <a <?php if($info1 !='' && $user5['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user5['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user5['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user5['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user5['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?><?php if($user5['user_id']!='') { ?>
                               <br/><?=$user5['username']?> <br/> <?php echo date('d-m-Y',strtotime($user5['registration_date']));?>
                            ...
                            <span>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user5['ref_id']); ?></td>
                                    </tr>


                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user5['user_id']);?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user5['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user5['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user5['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user5['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                              ...
                              <ul>
                                ...
                                <li>
                                  <a <?php if($info5 !='' && $user6['user_id']==''){ ?> href="#" <?php } else { ?> href="binary-tree.php?id=<?=$user6['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user6['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon" /><?php }else if($user6['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user6['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user6['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?><?php if($user6['user_id']!='') { ?>
                                    <br/><?=$user6['username']?><br/> <?php echo date('d-m-Y',strtotime($user6['registration_date']));?>
                                ...
                                <?php if($user6['user_id']!=''){?>  
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user6['ref_id']); ?></td>
                                    </tr>

                                  
  <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user6['user_id']);?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user6['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user6['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user6['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user6['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                                  ...
                                  <li>
                                   ...
                                   <br/><?=$user7['username']?><br/> <?php echo date('d-m-Y',strtotime($user7['registration_date']));?>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user7['ref_id']); ?></td>
                                    </tr>
                                     ...
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user7['user_id']);?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user7['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user7['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user7['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user7['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                    ...
                    <a <?php if($userid !='' && $user8['user_id']==''){ ?> href="#"  <?php } else { ?>  href="binary-tree.php?id=<?=$user8['user_id']?>" <?php } ?> class="tooltip1">   <?php if($user8['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user8['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user8['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?> <?php if($user8['user_id']!='') { ?>
                                    <br/><?=$user8['username']?> <br/> <?php echo date('d-m-Y',strtotime($user8['registration_date']));;?>
                      ...
                      <span>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user8['ref_id']); ?></td>
                                    </tr>
                                     ...
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user8['user_id']);?></td>
                                    </tr>
   ...
   <tr>
                                ...
                                <!--   <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user8['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user8['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user8['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user8['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
$working_e_wallet2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
 $working_e_wallet2['amount'];
                      ...
                      <ul>
                        ...
                        <li>
                          <a <?php if($info8 !='' && $user9['user_id']==''){ ?> href="#"  <?php } else { ?> href="binary-tree.php?id=<?=$user9['user_id']?>" <?php } ?> class="tooltip1"> <?php if($user9['user_rank_name']=="Free Member"){?><img src="images/RUBY.png" class="iicon" /><?php }else if($user9['user_rank_name']=="Paid Member"){?><img src="images/EMERALD.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Senior Manager"){?><img src="images/sm2.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Group Manager"){?><img src="images/group-manager.png" class="iicon"/><?php }else if($user9['user_rank_name']=="Director"){?><img src="images/director.png" class="iicon"/><?php }  else if($user9['user_rank_name']=="Normal User"){?><img src="images/member.gif" class="iicon"/><?php }  else{?><img src="images/empty.gif" class="iicon"/><br/><?php } ?><?php if($user9['user_id']!='') { ?>
                                    <br/><?=$user9['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user9['registration_date']));?>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user9['ref_id']); ?></td>
                                    </tr>
  ...
  <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user9['user_id']);?></td>
                                    </tr>
                                    <tr>
                                      <td align="left">Total Users:</td>
...
<tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user9['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user9['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
$working_e_wallet2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
 $working_e_wallet2['amount'];
  $rightamt1=$rightamt1+$working_e_wallet2['amount'];
                                 ...
                                 <!-- <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user9['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user9['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
 ...
 <br/><?=$user10['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user10['registration_date']));?>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user10['ref_id']); ?></td>
                                    </tr>
                                     ...
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user10['user_id']);?></td>
                                    </tr>
                 ...
                 <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user10['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user10['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
$working_e_wallet2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
 ...
 <br/><?=$user11['username']?>   <br/> <?php echo date('d-m-Y',strtotime($user11['registration_date']));?>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user11['ref_id']); ?></td>
                                    </tr>

                                  
  <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user11['user_id']);?></td>
                                    </tr>
                                    ...
                                    <tr>
                                     ...
                                     <!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user11['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user11['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
          ...
          <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user11['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user11['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
$working_e_wallet2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
 ...
 <br/><?=$user12['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user12['registration_date']));?>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user12['ref_id']); ?></td>
                                    </tr>

  				    <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user12['user_id']);?></td>
                                    </tr>
 ...
 <!-- <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user12['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user12['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
                         ...
                         <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user12['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user12['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<br/><?=$user13['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user13['registration_date']));?>
                                 ...
                                 <div class="flyout">
                                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                   <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user13['ref_id']); ?></td>
                                    </tr>

                                    
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user13['user_id']);?></td>
                                    </tr>
                               ...
                               <!--      <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user13['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user13['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
  ...
  <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user13['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user13['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
...
<br/><?=$user14['username']?>  <br/> <?php echo date('d-m-Y',strtotime($user14['registration_date']));?>
                             ...
                             <?php if($user14['user_id']!=''){?>        
                                 ...
                                 <div class="flyout">
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                      <td align="left">Sponsor ID:</td>
                                      <td align="left"><?php echo Display_username($user14['ref_id']); ?></td>
                                    </tr>
                                     ...
                                     <tr>
                                      <td align="left">Status:</td>
                                      <td align="left"><?php echo Display_user_status($user14['user_id']);?></td>
                                    </tr>
 <tr>
                                      <td align="left">Total Users:</td>
...
<!--  <tr>
                                      <td align="left">Total Business</td>
                                      <td align="left">L: <?php $regfs1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total1 from manage_bv_history where income_id='".$user14['user_id']."' and position='left' and description!='Carry Forward BV'")); if($regfs1['total1']!='' || $regfs1['total1']!=0) { echo $regfs1['total1']; } else { echo "0"; } ?> |  R: <?php $regfs2=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select sum(bv) as total2 from manage_bv_history where income_id='".$user14['user_id']."' and position='right' and description!='Carry Forward BV'")); if($regfs2['total2']!='' || $regfs2['total2']!=0) { echo $regfs2['total2']; } else { echo "0"; }  ?></td>
                                    </tr>
 ...
 -->
    <tr>
                                      ...
                                      <td align="left"> <?php
                                      $leftamt1=0;
$left_condi=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user14['user_id']."' and leg='left'");
...
$working_e_wallet1=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from working_e_wallet where user_id='$left_userid' "));
  $leftamt1=$leftamt1+$working_e_wallet1['amount'];
    ...
    $rightamt1=0;
$left_condi11=mysqli_query($GLOBALS["___mysqli_ston"], "select distinct(down_id) from level_income_binary where income_id='".$user14['user_id']."' and leg='right'");
    while($vccunt111=mysqli_fetch_array($left_condi11))
    {
