                ...
                <div class="panel-body">
                  <table class=" table table-bordered table-striped">
                    ...
                    <tbody>
                     ...
                     $i=1;
                          $data=mysqli_query($GLOBALS["___mysqli_ston"],"select * from customers where status=0 and ref_id='$userid' " );
                   
                      while($data1=mysqli_fetch_array($data)){
                      $datauser=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"],"select * from prospect_activity where user_id='".$data1['user_id']."' order by id desc limit 1"));
                     ?>
                        ...
                        <th scope="row"><?php echo $i;?></th>
                         ...
                         <!--<td><?php echo $data1['username'];?></td>-->
                          <!--<td><?php echo $data1['password'];?></td>-->
                           ...
                           <td><?php echo $datauser['ts'];?></td>
                           <td><a href="view-prospect-activity.php?id=<?php echo $data1['user_id'];?>" class="btn btn-sm btn-primary">View</a></td>
                      </tr>
