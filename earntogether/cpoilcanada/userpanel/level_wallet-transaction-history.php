          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                  <div class="row">
                  <div class="col-lg-6">
                    <h4 class="m-t-none m-b text-primary-lt font-thin-bold inline font-semi-bold">Level Wallet Transaction History</h4>
                </div>
                <div class="col-lg-6 text-right">
                    <?php $tito_wallet=mysqli_fetch_assoc(mysqli_query($GLOBALS["___mysqli_ston"], "select amount from level_e_wallet where user_id='$userid'"));
$tito_wallet_amount=$tito_wallet['amount']; ?>
 ...
 <a href="bh_export_ewallet_transaction.php?userid=<?=$userid;?>&wallet=B Wallet"><input type="submit" name="update" value="Export in CSV" class="btn btn-primary"></a>   
