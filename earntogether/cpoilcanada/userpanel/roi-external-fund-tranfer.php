...
?>
           ...
           <form name="bankinfo" method="post" action="roi-external-fund-transfer-confirm.php">
              <section class="panel panel-primary">

                <h4 class="m-t-none text-primary-lt font-thin-bold inline font-semi-bold" ><b>ROI EXTERNAL WALLET FUND TRANSFER</b></h4>
                
                <h4>CANTHO Wallet : <?php echo "$" ?> <?php $data=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from roi_e_wallet where user_id='$userid'"));?><?php  echo number_format($_SESSION['rates']*$data['amount'],2);?>
                  </h4>
                 
                
                <!--<p>Note: wallet fund transfer 8% charge will be only if user transfer fund in upline</p>--></header>
                <div class="panel-body">
                  <input name="wallet" id="wallet" type="hidden" required class="" style="width:4%;" value="roi_e_wallet" />
