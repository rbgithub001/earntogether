            ...
            <!-- ============================================================== -->
                ...
                <div class="content">
                    <div class="container">
                      ...
                      <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="m-t-0 header-title"><b>Active User</b></h4> 
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where ref_id='$userid' and designation!='Free user' order by id desc");
