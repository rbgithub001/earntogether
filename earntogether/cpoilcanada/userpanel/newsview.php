              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      ...
                      <p><?php
  $sql=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_faq where id='".$_GET['id']."'"));
   echo "<h3>".$sql['logo_title']."</h3>";print_r("<br/>");print_r("<br/>");
  echo $sql['logo_desc'];?> </p>
