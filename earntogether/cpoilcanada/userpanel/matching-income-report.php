            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Team Income Report</h4>
                </header>
                  ...
                  <table class="table datatable">
                    <thead>
                                        ...
                                        <th>Sr. No</th>
                                           ...
                                           <th>Direct Sponsor Userid</th>
                                           <th>Direct Sponsor Username</th>
                                             <th>Matching</th>
                                            <th>Commission</th>
                                            <th>Remark</th>
                      ...
                      $i=1;
                       $total=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Direct Mataching Income' order by id desc");
