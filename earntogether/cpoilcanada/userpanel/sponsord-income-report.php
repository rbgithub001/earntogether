          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <h4 class="m-t-none text-primary-lt font-thin-bold inline m-b font-semi-bold">SPONSOR INCOME REPORT</h4>
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $total=0;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Sponsor Income' order by id desc");
