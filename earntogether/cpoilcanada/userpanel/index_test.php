   ...
   <div class="col-md-6 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 100px;">
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="stats">
                                                            <i class="material-icons text-info">info</i>
                                                            <a href="invoice-report.php">See detailed report</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<!--                                             <div class="col-md-3 col-sm-6">
                                            ...
                                            <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats blue-bg" style="min-height: 100px;">
                                                    ...
                                                    <div class="card-content"><!-- Investments -->
                                                        <p class="category"><strong>My Total Chips</strong></p>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                    <div class="card card-stats blue-bg" style="min-height: 100px;">
                                                        ...
                                                        <div class="card-content">
                                                            <p class="category"><strong>Total Team Chips</strong></p>
                                          ...
                                          <?php //$total_earning99=$total_earning['amount']*11755.40;?>
                                           <!--    <div class="col-md-3 col-sm-6">
                                                <div class="card card-stats" style="min-height: 100px;">
                                                    <div class="card-header">
                                                        <div class="icon icon-warning">
                                                    ...
                                                    <div class="card-content">
                                                        <p class="category"><strong>Pool Balance</strong></p>
                                                        <h3 class="card-title">USD <?php  echo number_format($total_earning99,8) ;  ?></h3>
                                                    </div> -->
                                                    <!--<div class="card-footer">
                                                        <div class="stats">
                                                            <i class="material-icons text-info">info</i>
...
?>
            ...
            <div class="">
              ...
              <div class="">
                <div class="row">
                <div class="col-md-6">
                  <section class="card hovercard" style="border-radius: 0px !important;">
   ...
   <div class="desc" style="font-size: 16px;">Activation : <?php if($f['user_rank_name']=='Free Member'){ echo "Inactive"; }else{ echo "Active"; }?> </div>
                        ...
                        echo $fdert['first_name']." ".$fdert['last_name'];?></div> -->
                                            ...
                                            <div class="col-md-6">
                                                    <div class="card card-stats white2-bg" style="min-height: 100px;">
                                                        <div class="card-content">
                                                          <div id="block-afl-widgets-afl-block-promotion-tools">
                                                            <h3>Promotion Tools</h3>
                                                            <p><a href="http://182.76.237.227/~syscheck/betvest/userpanel/register.php?referral=betvest" style="color: blue;">betvest.com</a></p>
                                                            <div class="social-medi-icons padder-md">
                                                              <a target="_blank" href="http://www.facebook.com/sharer.php?u=http://182.76.237.227/~syscheck/betvest/register.php?referral=betvest">
                                                                <img class="img-circle img-responsive" src="images/facebook.png" alt="">
                                                              </a>
                                                              <a target="_blank" href="http://twitter.com/share?url=http://182.76.237.227/~syscheck/betvest/betvest">
                                                                <img class="img-circle img-responsive" src="images/twitter.png" alt="">
                                                              </a>
                                                              <a target="_blank" href="https://api.whatsapp.com/send?text=http://182.76.237.227/~syscheck/betvest/betvest">
                                                                <img class="img-circle img-responsive" src="images/whatsapp2.png" alt="">
                                                              </a>
                                                              <a target="_blank" href="https://plusone.google.com/_/+1/confirm?hl=en&url=http://182.76.237.227/~syscheck/betvest/register.php?referral=betvest">
...
<!-- 
                ...
                $image = array('<img class="img-circle img-responsive" src="https://binary.epixelmlmsoftware.com/sites/binary/files/user-profile-images/formal-fashion-for-him.png" width="104" height="104" alt="">','<img class="img-circle img-responsive" src="https://binary.epixelmlmsoftware.com/sites/binary/files/user-profile-images/career.jpg" width="104" height="104" alt="">','<img class="img-circle img-responsive" src="https://binary.epixelmlmsoftware.com/sites/binary/files/user-profile-images/adult_close_up_eyeglasses_eyewear_face_facial_expression_fashion_fashion_model-1000789.jpg%21d.jpeg" width="104" height="104" alt="">','<img class="img-circle img-responsive" src="https://binary.epixelmlmsoftware.com/sites/binary/files/user-profile-images/jason-emery-fltc-066-4-800x440.jpg" width="104" height="104" alt="">');
                 $top_earner = mysqli_query($GLOBALS["___mysqli_ston"], "select * from final_e_wallet order by amount desc limit 4");
