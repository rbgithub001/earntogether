...
mysqli_query($GLOBALS["___mysqli_ston"], "insert into credit_debit values(NULL,'$invoice_no','$idd','$amount','0','0','$idd','$idd','$date','Add Fund','Add Fund','Add Fund','Add Fund','$invoice_no','','0','CANTHO Wallet','CURRENT_TIMESTAMP','$urls','','','')");	
