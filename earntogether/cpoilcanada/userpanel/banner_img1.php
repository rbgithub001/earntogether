                ...
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from manage_slider order by id desc");
                     ...
                     ?>
                      ...
                      <tr>
                        ...
                        <td><img src="../cmsadmin/banner_images/<?php echo $data1['banner_image']; ?>" >
                        
                        
                        </td><th scope="row"><?php echo $i;?></th>
                          <img src="../cmsadmin/banner_images/<?php echo $data1['m_image']; ?>" >
