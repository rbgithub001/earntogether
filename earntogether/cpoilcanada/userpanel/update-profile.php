...
if (filter_var($first11, FILTER_VALIDATE_INT) === false) {
    header("location:update-profile.php?msg=Use only integer values !");
    exit; 
}
...
mysqli_query($GLOBALS["___mysqli_ston"], "update user_registration set first_name='$first1',ltc_add='$ltc_add',etc_add='$etc_add', last_name='$first2', email='$first3', telephone='$first11', update_status='1', btc_add='$btc_add', trx_address='$trx_address', paypal='$paypal' where user_id='$userid'");
...
$mail->setFrom('srdev@maxtratechnologies.net', 'Vines Realty');
//Set an alternative reply-to address
$mail->addReplyTo('srdev@maxtratechnologies.net', 'Vines Realty');
//Set who the message is to be sent to
$mail->addAddress($email, 'Vines Realty');
...
color: rgb(38, 38, 38);width: 100%;margin-top: 24px;">
                ...
                <p style="font-family: Lato, Arial; font-weight: 400; font-size: 15px; line-height: 24px; color: #0c0b0c; -webkit-font-smoothing: antialiased; margin: 26px 0px 0px !important;">
                  Copyrights 2021 Vines Realty. All Rights Reserved. </p>
