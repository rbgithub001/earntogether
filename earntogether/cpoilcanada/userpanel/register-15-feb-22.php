...
else
{
 ...
 ?>
  ...
  document.getElementById("sponsorid").readOnly = true;
        ...
        <title>Welcome to Ridhira Living</title>
	...
	<style type="text/css">
    .login-page{
		background:url(images/vladimir-haltakov-CQDutGGkAjk-unsplash.jpg) repeat !important;
    ...
    <body class="login-page authentication-bg">
        ...
        (function() {
          ...
          //  });
                ...
                if($('#number').val()!=''){
                    ...
                    cou = phonen.length;
                    var phonereg = /^[0-9+]+$/;
    		        if(!phonereg.test(phonen) || cou < 10) {
    		            empty7 = true;
                ...
                if(empty3==false && empty4==false && empty5==false && empty6==false && empty7==false && empty8==false && empty9==false) {
