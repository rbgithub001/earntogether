...
<?php echo "select * from credit_debit where ttype='Binary Income' $qry"; ?>
                            ...
                            <?php 
                                  ...
                                  $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where ttype='Binary Income' $qry");
