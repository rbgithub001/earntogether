            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Wallet Transaction History</h4>
                </header>
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysqli_query($GLOBALS["___mysqli_ston"], "select * from credit_debit where user_id='$userid' and ttype='Fund Transfer' order by id desc");
                      ...
                      <tr>
                        ...
                        <td><?php echo $data11['first_name']." ".$data11['last_name'];?></td>
                         <td><?php echo $data1['sender_id'];?></td>
                           <?php $data111=mysqli_fetch_array(mysqli_query($GLOBALS["___mysqli_ston"], "select * from user_registration where user_id='".$data1['receiver_id']."'"));?>
                        <td><?php echo $data111['first_name']." ".$data111['last_name'];?></td>
