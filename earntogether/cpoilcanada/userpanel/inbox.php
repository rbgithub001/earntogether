          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <table class="table messages-table table-hover">
                <tbody>
                <?php
                while($x11=mysqli_fetch_array($res11))
                {
                ?>
                  <tr class="unread starred">
                     <td class="from"><div><a href="view-message.php?inbox=inbox&id=<?=$x11['id']?>">J<?=$x11['sender_name']?></a></div></td>
...
<?php if($x11['file_name']){?><a href="attachfile/<?=$x11['file_name']?>" target="_blank">   <span class="label label-danger">Attach File</span></a><?php } else {} ?>
                    <a href="view-message.php?inbox=inbox&id=<?=$x11['id']?>"><?=$x11['subject']?></a></div></td>
                    <td class="summary hidden-xs"><div><a href="view-message.php?inbox=inbox&id=<?=$x11['id']?>"> <?php echo substr($x11['message'],0,20);?></a></div></td>
                    <td class="date-time text-right"><a href="view-message.php?inbox=inbox&id=<?=$x11['id']?>"><?php echo $x11['msg_date'];?></a></td>
                  </tr>
                  <?php } ?>
